# kubernetes_asyncio.ApiregistrationV1Api
...
# **create_api_service**
> V1APIService create_api_service(v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.ApiregistrationV1Api(api_client)
    v1_api_service = kubernetes_asyncio.V1APIService() # V1APIService | 
    ...
    try:
        api_response = await api_instance.create_api_service(v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
------------- | ------------- | ------------- | -------------
 **v1_api_service** | [**V1APIService**](V1APIService.md)|  | 
...
# **delete_api_service**
> V1Status delete_api_service(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_api_service(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
```python
import kubernetes_asyncio
from kubernetes_asyncio.models.v1_api_service_list import V1APIServiceList
from kubernetes_asyncio.rest import ApiException
from pprint import pprint
...
# **replace_api_service**
> V1APIService replace_api_service(name, v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_api_service(name, v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1APIService replace_api_service_status(name, v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_api_service_status(name, v1_api_service, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
