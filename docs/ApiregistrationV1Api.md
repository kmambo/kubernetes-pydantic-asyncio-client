# kubernetes_asyncio_pydantic.ApiregistrationV1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.ApiregistrationV1Api(api_client)
    v1_api_service = kubernetes_asyncio_pydantic.V1APIService() # V1APIService | 
...
# **delete_api_service**
> V1Status delete_api_service(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, ignore_store_read_error_with_cluster_breaking_potential=ignore_store_read_error_with_cluster_breaking_potential, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1_api_service_list import V1APIServiceList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
