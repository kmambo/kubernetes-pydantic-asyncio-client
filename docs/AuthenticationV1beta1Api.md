# kubernetes_asyncio_pydantic.AuthenticationV1beta1Api
...
> V1beta1SelfSubjectReview create_self_subject_review(v1beta1_self_subject_review, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, pretty=pretty)
...
from kubernetes_asyncio_pydantic.models.v1beta1_self_subject_review import V1beta1SelfSubjectReview
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.AuthenticationV1beta1Api(api_client)
    v1beta1_self_subject_review = kubernetes_asyncio_pydantic.V1beta1SelfSubjectReview() # V1beta1SelfSubjectReview | 
    ...
    try:
        api_response = await api_instance.create_self_subject_review(v1beta1_self_subject_review, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, pretty=pretty)
        print("The response of AuthenticationV1beta1Api->create_self_subject_review:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthenticationV1beta1Api->create_self_subject_review: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **v1beta1_self_subject_review** | [**V1beta1SelfSubjectReview**](V1beta1SelfSubjectReview.md)|  | 
...
[**V1beta1SelfSubjectReview**](V1beta1SelfSubjectReview.md)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AuthenticationV1beta1Api->get_api_resources:\n")
        pprint(api_response)
    except Exception as e:
