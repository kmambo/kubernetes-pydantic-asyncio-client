# kubernetes_asyncio.AuthenticationV1beta1Api
...
from kubernetes_asyncio.models.v1beta1_self_subject_review import V1beta1SelfSubjectReview
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.AuthenticationV1beta1Api(api_client)
    v1beta1_self_subject_review = kubernetes_asyncio.V1beta1SelfSubjectReview() # V1beta1SelfSubjectReview | 
