# kubernetes_asyncio_pydantic.AutoscalingV1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.AutoscalingV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_horizontal_pod_autoscaler = kubernetes_asyncio_pydantic.V1HorizontalPodAutoscaler() # V1HorizontalPodAutoscaler | 
