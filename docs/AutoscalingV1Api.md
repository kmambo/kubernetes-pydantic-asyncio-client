# kubernetes_asyncio.AutoscalingV1Api
...
> V1HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.AutoscalingV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_horizontal_pod_autoscaler = kubernetes_asyncio.V1HorizontalPodAutoscaler() # V1HorizontalPodAutoscaler | 
    ...
    try:
        api_response = await api_instance.create_namespaced_horizontal_pod_autoscaler(namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
 ...
 **v1_horizontal_pod_autoscaler** | [**V1HorizontalPodAutoscaler**](V1HorizontalPodAutoscaler.md)|  | 
...
> V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(name, namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_horizontal_pod_autoscaler(name, namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, v1_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
