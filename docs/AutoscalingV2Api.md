# kubernetes_asyncio.AutoscalingV2Api
...
> V2HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.AutoscalingV2Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v2_horizontal_pod_autoscaler = kubernetes_asyncio.V2HorizontalPodAutoscaler() # V2HorizontalPodAutoscaler | 
    ...
    try:
        api_response = await api_instance.create_namespaced_horizontal_pod_autoscaler(namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
 ...
 **v2_horizontal_pod_autoscaler** | [**V2HorizontalPodAutoscaler**](V2HorizontalPodAutoscaler.md)|  | 
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_collection_namespaced_horizontal_pod_autoscaler(namespace, pretty=pretty, var_continue=var_continue, dry_run=dry_run, field_selector=field_selector, grace_period_seconds=grace_period_seconds, label_selector=label_selector, limit=limit, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, v1_delete_options=v1_delete_options)
...
> V1Status delete_namespaced_horizontal_pod_autoscaler(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_namespaced_horizontal_pod_autoscaler(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_horizontal_pod_autoscaler_for_all_namespaces(allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_namespaced_horizontal_pod_autoscaler(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_namespaced_horizontal_pod_autoscaler(name, namespace, pretty=pretty)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_namespaced_horizontal_pod_autoscaler_status(name, namespace, pretty=pretty)
...
> V2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(name, namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_horizontal_pod_autoscaler(name, namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, v2_horizontal_pod_autoscaler, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
