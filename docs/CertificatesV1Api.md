# kubernetes_asyncio.CertificatesV1Api
...
> V1CertificateSigningRequest create_certificate_signing_request(v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
from kubernetes_asyncio.models.v1_certificate_signing_request import V1CertificateSigningRequest
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.CertificatesV1Api(api_client)
    v1_certificate_signing_request = kubernetes_asyncio.V1CertificateSigningRequest() # V1CertificateSigningRequest | 
    ...
    try:
        api_response = await api_instance.create_certificate_signing_request(v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
------------- | ------------- | ------------- | -------------
 **v1_certificate_signing_request** | [**V1CertificateSigningRequest**](V1CertificateSigningRequest.md)|  | 
...
> V1Status delete_certificate_signing_request(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_certificate_signing_request(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
```python
import kubernetes_asyncio
from kubernetes_asyncio.models.v1_certificate_signing_request_list import V1CertificateSigningRequestList
from kubernetes_asyncio.rest import ApiException
from pprint import pprint
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_certificate_signing_request(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_certificate_signing_request_approval(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_certificate_signing_request_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_certificate_signing_request(name, pretty=pretty)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_certificate_signing_request_approval(name, pretty=pretty)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_certificate_signing_request_status(name, pretty=pretty)
...
> V1CertificateSigningRequest replace_certificate_signing_request(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_certificate_signing_request(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1CertificateSigningRequest replace_certificate_signing_request_approval(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_certificate_signing_request_approval(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1CertificateSigningRequest replace_certificate_signing_request_status(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_certificate_signing_request_status(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
