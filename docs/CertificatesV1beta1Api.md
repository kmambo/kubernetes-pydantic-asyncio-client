# kubernetes_asyncio_pydantic.CertificatesV1beta1Api
...
> V1beta1ClusterTrustBundle create_cluster_trust_bundle(v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.CertificatesV1beta1Api(api_client)
    v1beta1_cluster_trust_bundle = kubernetes_asyncio_pydantic.V1beta1ClusterTrustBundle() # V1beta1ClusterTrustBundle | 
    ...
    try:
        api_response = await api_instance.create_cluster_trust_bundle(v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
------------- | ------------- | ------------- | -------------
 **v1beta1_cluster_trust_bundle** | [**V1beta1ClusterTrustBundle**](V1beta1ClusterTrustBundle.md)|  | 
...
> V1beta1ClusterTrustBundle replace_cluster_trust_bundle(name, v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_cluster_trust_bundle(name, v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
