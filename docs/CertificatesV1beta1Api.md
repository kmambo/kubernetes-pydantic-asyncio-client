# kubernetes_asyncio.client.CertificatesV1beta1Api
...
async with kubernetes_asyncio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.client.CertificatesV1beta1Api(api_client)
    body = kubernetes_asyncio.client.V1beta1ClusterTrustBundle() # V1beta1ClusterTrustBundle | 
