# kubernetes_asyncio.CertificatesV1beta1Api
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.CertificatesV1beta1Api(api_client)
    v1beta1_cluster_trust_bundle = kubernetes_asyncio.V1beta1ClusterTrustBundle() # V1beta1ClusterTrustBundle | 
