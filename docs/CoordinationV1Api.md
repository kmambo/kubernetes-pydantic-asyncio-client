# kubernetes_asyncio_pydantic.CoordinationV1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.CoordinationV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_lease = kubernetes_asyncio_pydantic.V1Lease() # V1Lease | 
