# kubernetes_asyncio_pydantic.CoordinationV1alpha2Api
...
> V1alpha2LeaseCandidate create_namespaced_lease_candidate(namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.CoordinationV1alpha2Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1alpha2_lease_candidate = kubernetes_asyncio_pydantic.V1alpha2LeaseCandidate() # V1alpha2LeaseCandidate | 
    ...
    try:
        api_response = await api_instance.create_namespaced_lease_candidate(namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
 ...
 **v1alpha2_lease_candidate** | [**V1alpha2LeaseCandidate**](V1alpha2LeaseCandidate.md)|  | 
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1alpha2_lease_candidate_list import V1alpha2LeaseCandidateList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
...
> V1alpha2LeaseCandidate replace_namespaced_lease_candidate(name, namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_lease_candidate(name, namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
