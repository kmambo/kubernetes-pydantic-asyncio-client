# kubernetes_asyncio.CoordinationV1alpha2Api
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.CoordinationV1alpha2Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1alpha2_lease_candidate = kubernetes_asyncio.V1alpha2LeaseCandidate() # V1alpha2LeaseCandidate | 
...
```python
import kubernetes_asyncio
from kubernetes_asyncio.models.v1alpha2_lease_candidate_list import V1alpha2LeaseCandidateList
from kubernetes_asyncio.rest import ApiException
from pprint import pprint
