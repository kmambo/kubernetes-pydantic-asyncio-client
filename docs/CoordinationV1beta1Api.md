# kubernetes_asyncio_pydantic.CoordinationV1beta1Api
...
> V1beta1LeaseCandidate create_namespaced_lease_candidate(namespace, v1beta1_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
from kubernetes_asyncio_pydantic.models.v1beta1_lease_candidate import V1beta1LeaseCandidate
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.CoordinationV1beta1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1beta1_lease_candidate = kubernetes_asyncio_pydantic.V1beta1LeaseCandidate() # V1beta1LeaseCandidate | 
    ...
    try:
        api_response = await api_instance.create_namespaced_lease_candidate(namespace, v1beta1_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
 ...
 **v1beta1_lease_candidate** | [**V1beta1LeaseCandidate**](V1beta1LeaseCandidate.md)|  | 
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1beta1_lease_candidate_list import V1beta1LeaseCandidateList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
...
> V1beta1LeaseCandidate replace_namespaced_lease_candidate(name, namespace, v1beta1_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_lease_candidate(name, namespace, v1beta1_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
