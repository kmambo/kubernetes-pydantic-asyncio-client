# kubernetes_asyncio.CoordinationV1beta1Api
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.CoordinationV1beta1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1beta1_lease_candidate = kubernetes_asyncio.V1beta1LeaseCandidate() # V1beta1LeaseCandidate | 
...
```python
import kubernetes_asyncio
from kubernetes_asyncio.models.v1beta1_lease_candidate_list import V1beta1LeaseCandidateList
from kubernetes_asyncio.rest import ApiException
from pprint import pprint
