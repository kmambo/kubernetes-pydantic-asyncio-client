# kubernetes_asyncio.client.CoordinationV1beta1Api
...
async with kubernetes_asyncio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.client.CoordinationV1beta1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    body = kubernetes_asyncio.client.V1beta1LeaseCandidate() # V1beta1LeaseCandidate | 
