# kubernetes_asyncio.DiscoveryV1Api
...
> V1EndpointSlice create_namespaced_endpoint_slice(namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.DiscoveryV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_endpoint_slice = kubernetes_asyncio.V1EndpointSlice() # V1EndpointSlice | 
    ...
    try:
        api_response = await api_instance.create_namespaced_endpoint_slice(namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
 ...
 **v1_endpoint_slice** | [**V1EndpointSlice**](V1EndpointSlice.md)|  | 
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_collection_namespaced_endpoint_slice(namespace, pretty=pretty, var_continue=var_continue, dry_run=dry_run, field_selector=field_selector, grace_period_seconds=grace_period_seconds, label_selector=label_selector, limit=limit, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, v1_delete_options=v1_delete_options)
...
> V1Status delete_namespaced_endpoint_slice(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_namespaced_endpoint_slice(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
```python
import kubernetes_asyncio
from kubernetes_asyncio.models.v1_endpoint_slice_list import V1EndpointSliceList
from kubernetes_asyncio.rest import ApiException
from pprint import pprint
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_endpoint_slice_for_all_namespaces(allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_namespaced_endpoint_slice(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_namespaced_endpoint_slice(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_namespaced_endpoint_slice(name, namespace, pretty=pretty)
...
> V1EndpointSlice replace_namespaced_endpoint_slice(name, namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_namespaced_endpoint_slice(name, namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
