# kubernetes_asyncio_pydantic.NodeV1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.NodeV1Api(api_client)
    v1_runtime_class = kubernetes_asyncio_pydantic.V1RuntimeClass() # V1RuntimeClass | 
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1_runtime_class_list import V1RuntimeClassList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
