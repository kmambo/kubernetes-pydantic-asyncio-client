# kubernetes_asyncio_pydantic.PolicyV1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.PolicyV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_pod_disruption_budget = kubernetes_asyncio_pydantic.V1PodDisruptionBudget() # V1PodDisruptionBudget | 
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_namespaced_pod_disruption_budget(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, ignore_store_read_error_with_cluster_breaking_potential=ignore_store_read_error_with_cluster_breaking_potential, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
