...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    v1alpha3_device_taint_rule = kubernetes_asyncio_pydantic.V1alpha3DeviceTaintRule() # V1alpha3DeviceTaintRule | 
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1alpha3_device_taint_rule_list import V1alpha3DeviceTaintRuleList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
