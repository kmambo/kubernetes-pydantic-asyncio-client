...
from kubernetes_asyncio.client.models.v1alpha1_volume_attributes_class import V1alpha1VolumeAttributesClass
...
async with kubernetes_asyncio.client.ApiClient(configuration) as api_client:
    ...
    body = kubernetes_asyncio.client.V1alpha1VolumeAttributesClass() # V1alpha1VolumeAttributesClass | 
