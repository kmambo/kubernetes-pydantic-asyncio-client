# kubernetes_asyncio.StorageV1beta1Api
...
> V1beta1VolumeAttributesClass create_volume_attributes_class(v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
from kubernetes_asyncio.models.v1beta1_volume_attributes_class import V1beta1VolumeAttributesClass
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.StorageV1beta1Api(api_client)
    v1beta1_volume_attributes_class = kubernetes_asyncio.V1beta1VolumeAttributesClass() # V1beta1VolumeAttributesClass | 
    ...
    try:
        api_response = await api_instance.create_volume_attributes_class(v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
------------- | ------------- | ------------- | -------------
 **v1beta1_volume_attributes_class** | [**V1beta1VolumeAttributesClass**](V1beta1VolumeAttributesClass.md)|  | 
...
> V1beta1VolumeAttributesClass delete_volume_attributes_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
> V1beta1VolumeAttributesClass replace_volume_attributes_class(name, v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_volume_attributes_class(name, v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
