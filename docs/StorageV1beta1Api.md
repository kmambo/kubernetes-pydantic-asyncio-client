# kubernetes_asyncio_pydantic.StorageV1beta1Api
...
from kubernetes_asyncio_pydantic.models.v1beta1_volume_attributes_class import V1beta1VolumeAttributesClass
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.StorageV1beta1Api(api_client)
    v1beta1_volume_attributes_class = kubernetes_asyncio_pydantic.V1beta1VolumeAttributesClass() # V1beta1VolumeAttributesClass | 
