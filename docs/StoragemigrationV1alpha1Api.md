# kubernetes_asyncio.StoragemigrationV1alpha1Api
...
> V1alpha1StorageVersionMigration create_storage_version_migration(v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
from kubernetes_asyncio.models.v1alpha1_storage_version_migration import V1alpha1StorageVersionMigration
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.StoragemigrationV1alpha1Api(api_client)
    v1alpha1_storage_version_migration = kubernetes_asyncio.V1alpha1StorageVersionMigration() # V1alpha1StorageVersionMigration | 
    ...
    try:
        api_response = await api_instance.create_storage_version_migration(v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
------------- | ------------- | ------------- | -------------
 **v1alpha1_storage_version_migration** | [**V1alpha1StorageVersionMigration**](V1alpha1StorageVersionMigration.md)|  | 
...
> V1Status delete_storage_version_migration(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.delete_storage_version_migration(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, v1_delete_options=v1_delete_options)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_storage_version_migration(pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_storage_version_migration(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.patch_storage_version_migration_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_storage_version_migration(name, pretty=pretty)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.read_storage_version_migration_status(name, pretty=pretty)
...
> V1alpha1StorageVersionMigration replace_storage_version_migration(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_storage_version_migration(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1alpha1StorageVersionMigration replace_storage_version_migration_status(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
async with kubernetes_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.replace_storage_version_migration_status(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
