# kubernetes_asyncio_pydantic.StoragemigrationV1alpha1Api
...
async with kubernetes_asyncio_pydantic.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio_pydantic.StoragemigrationV1alpha1Api(api_client)
    v1alpha1_storage_version_migration = kubernetes_asyncio_pydantic.V1alpha1StorageVersionMigration() # V1alpha1StorageVersionMigration | 
...
```python
import kubernetes_asyncio_pydantic
from kubernetes_asyncio_pydantic.models.v1alpha1_storage_version_migration_list import V1alpha1StorageVersionMigrationList
from kubernetes_asyncio_pydantic.rest import ApiException
from pprint import pprint
