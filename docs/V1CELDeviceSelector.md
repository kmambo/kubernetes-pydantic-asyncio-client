...
```python
from kubernetes_asyncio_pydantic.models.v1_cel_device_selector import V1CELDeviceSelector

# TODO update the JSON string below
json = "{}"
# create an instance of V1CELDeviceSelector from a JSON string
v1_cel_device_selector_instance = V1CELDeviceSelector.from_json(json)
# print the JSON string representation of the object
print(V1CELDeviceSelector.to_json())

# convert the object into a dict
v1_cel_device_selector_dict = v1_cel_device_selector_instance.to_dict()
# create an instance of V1CELDeviceSelector from a dict
v1_cel_device_selector_from_dict = V1CELDeviceSelector.from_dict(v1_cel_device_selector_dict)
```
