...
```python
from kubernetes_asyncio_pydantic.models.v1_capacity_request_policy_range import V1CapacityRequestPolicyRange

# TODO update the JSON string below
json = "{}"
# create an instance of V1CapacityRequestPolicyRange from a JSON string
v1_capacity_request_policy_range_instance = V1CapacityRequestPolicyRange.from_json(json)
# print the JSON string representation of the object
print(V1CapacityRequestPolicyRange.to_json())

# convert the object into a dict
v1_capacity_request_policy_range_dict = v1_capacity_request_policy_range_instance.to_dict()
# create an instance of V1CapacityRequestPolicyRange from a dict
v1_capacity_request_policy_range_from_dict = V1CapacityRequestPolicyRange.from_dict(v1_capacity_request_policy_range_dict)
```
