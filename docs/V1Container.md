...
**resources** | [**V1ResourceRequirements**](V1ResourceRequirements.md) | Compute Resources required by this container. Cannot be updated. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/ | [optional] 
...
v1_container_instance = V1Container.from_json(json)
# print the JSON string representation of the object
print(V1Container.to_json())

# convert the object into a dict
v1_container_dict = v1_container_instance.to_dict()
# create an instance of V1Container from a dict
v1_container_from_dict = V1Container.from_dict(v1_container_dict)
```
