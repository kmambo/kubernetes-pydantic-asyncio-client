...
------------ | ------------- | ------------- | -------------
**container_name** | **str** | The name of the container requesting resources. | [default to '']
**request_name** | **str** | The name of the request in the special ResourceClaim which corresponds to the extended resource. | [default to '']
**resource_name** | **str** | The name of the extended resource in that container which gets backed by DRA. | [default to '']
