...
**node_selector** | [**V1NodeSelector**](V1NodeSelector.md) | NodeSelector defines the nodes where the device is available.  Must use exactly one term.  Must only be set if Spec.PerDeviceNodeSelection is set to true. At most one of NodeName, NodeSelector and AllNodes can be set. | [optional] 
...
```python
from kubernetes_asyncio_pydantic.models.v1_device import V1Device

# TODO update the JSON string below
json = "{}"
# create an instance of V1Device from a JSON string
v1_device_instance = V1Device.from_json(json)
# print the JSON string representation of the object
print(V1Device.to_json())

# convert the object into a dict
v1_device_dict = v1_device_instance.to_dict()
# create an instance of V1Device from a dict
v1_device_from_dict = V1Device.from_dict(v1_device_dict)
```
