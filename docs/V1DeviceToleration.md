...
**operator** | **str** | Operator represents a key&#39;s relationship to the value. Valid operators are Exists and Equal. Defaults to Equal. Exists is equivalent to wildcard for value, so that a ResourceClaim can tolerate all taints of a particular category. | [optional] [default to 'Equal']
...
v1_device_toleration_instance = V1DeviceToleration.from_json(json)
# print the JSON string representation of the object
print(V1DeviceToleration.to_json())

# convert the object into a dict
v1_device_toleration_dict = v1_device_toleration_instance.to_dict()
# create an instance of V1DeviceToleration from a dict
v1_device_toleration_from_dict = V1DeviceToleration.from_dict(v1_device_toleration_dict)
```
