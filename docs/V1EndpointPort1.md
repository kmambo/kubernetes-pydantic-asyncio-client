...
```python
from kubernetes_asyncio_pydantic.models.v1_endpoint_port1 import V1EndpointPort1

# TODO update the JSON string below
json = "{}"
# create an instance of V1EndpointPort1 from a JSON string
v1_endpoint_port1_instance = V1EndpointPort1.from_json(json)
# print the JSON string representation of the object
print(V1EndpointPort1.to_json())

# convert the object into a dict
v1_endpoint_port1_dict = v1_endpoint_port1_instance.to_dict()
# create an instance of V1EndpointPort1 from a dict
v1_endpoint_port1_from_dict = V1EndpointPort1.from_dict(v1_endpoint_port1_dict)
```
