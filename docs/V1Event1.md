...
**metadata** | [**V1ObjectMeta**](V1ObjectMeta.md) | Standard object&#39;s metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata | 
...
**reporting_component** | **str** | Name of the controller that emitted this Event, e.g. &#x60;kubernetes.io/kubelet&#x60;. | [optional] [default to '']
**reporting_instance** | **str** | ID of the controller instance, e.g. &#x60;kubelet-xyzf&#x60;. | [optional] [default to '']
**series** | [**V1EventSeries1**](V1EventSeries1.md) | Data about the Event series this event represents or nil if it&#39;s a singleton Event. | [optional] 
...
json = "{}"
# create an instance of V1Event1 from a JSON string
v1_event1_instance = V1Event1.from_json(json)
# print the JSON string representation of the object
print(V1Event1.to_json())

# convert the object into a dict
v1_event1_dict = v1_event1_instance.to_dict()
# create an instance of V1Event1 from a dict
v1_event1_from_dict = V1Event1.from_dict(v1_event1_dict)
```
