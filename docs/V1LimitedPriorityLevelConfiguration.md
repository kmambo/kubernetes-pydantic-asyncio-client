...
**limit_response** | [**V1LimitResponse**](V1LimitResponse.md) | &#x60;limitResponse&#x60; indicates what to do with requests that can not be executed right now | [optional] 
...
```python
from kubernetes_asyncio_pydantic.models.v1_limited_priority_level_configuration import V1LimitedPriorityLevelConfiguration
