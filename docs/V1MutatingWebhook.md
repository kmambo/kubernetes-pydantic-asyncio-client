...
**kubernetes_asyncio.client_config** | [**AdmissionregistrationV1WebhookClientConfig**](AdmissionregistrationV1WebhookClientConfig.md) |  | 
...
v1_mutating_webhook_instance = V1MutatingWebhook.from_json(json)
# print the JSON string representation of the object
print(V1MutatingWebhook.to_json())

# convert the object into a dict
v1_mutating_webhook_dict = v1_mutating_webhook_instance.to_dict()
# create an instance of V1MutatingWebhook from a dict
v1_mutating_webhook_from_dict = V1MutatingWebhook.from_dict(v1_mutating_webhook_dict)
```
