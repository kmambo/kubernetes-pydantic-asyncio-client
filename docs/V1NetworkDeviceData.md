...
v1_network_device_data_instance = V1NetworkDeviceData.from_json(json)
# print the JSON string representation of the object
print(V1NetworkDeviceData.to_json())

# convert the object into a dict
v1_network_device_data_dict = v1_network_device_data_instance.to_dict()
# create an instance of V1NetworkDeviceData from a dict
v1_network_device_data_from_dict = V1NetworkDeviceData.from_dict(v1_network_device_data_dict)
```
