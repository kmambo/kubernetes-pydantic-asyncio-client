...
**resource_claim_name** | **str** | ResourceClaimName is the name of the ResourceClaim that was generated for the Pod in the namespace of the Pod. | [default to '']

## Example

```python
from kubernetes_asyncio_pydantic.models.v1_pod_extended_resource_claim_status import V1PodExtendedResourceClaimStatus
