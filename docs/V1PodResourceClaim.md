...
**source** | [**V1ClaimSource**](V1ClaimSource.md) | Source describes where to find the ResourceClaim. | [optional] 

## Example

```python
from kubernetes_asyncio.models.v1_pod_resource_claim import V1PodResourceClaim
