...
**extended_resource_claim_status** | [**V1PodExtendedResourceClaimStatus**](V1PodExtendedResourceClaimStatus.md) | Status of extended resource claim backed by DRA. | [optional] 
