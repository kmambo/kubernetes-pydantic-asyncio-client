...
**grpc** | [**V1GRPCAction**](V1GRPCAction.md) | GRPC specifies an action involving a GRPC port. | [optional] 
...
**tcp_socket** | [**V1TCPSocketAction**](V1TCPSocketAction.md) | TCPSocket specifies an action involving a TCP port. | [optional] 
...
```python
from kubernetes_asyncio.models.v1_probe import V1Probe
