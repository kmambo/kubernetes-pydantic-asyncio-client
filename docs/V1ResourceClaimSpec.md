...
------------ | ------------- | ------------- | -------------
**devices** | [**V1DeviceClaim**](V1DeviceClaim.md) | Devices defines how to request devices. | [optional] 

## Example

```python
from kubernetes_asyncio_pydantic.models.v1_resource_claim_spec import V1ResourceClaimSpec
