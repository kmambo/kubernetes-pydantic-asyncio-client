...
------------ | ------------- | ------------- | -------------
**replicas** | **int** | replicas is the desired number of instances for the scaled object. | [optional] [default to 0]

## Example

```python
from kubernetes_asyncio_pydantic.models.v1_scale_spec import V1ScaleSpec
