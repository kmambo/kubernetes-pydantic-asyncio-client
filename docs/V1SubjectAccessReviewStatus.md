...
------------ | ------------- | ------------- | -------------
**allowed** | **bool** | Allowed is required. True if the action would be allowed, false otherwise. | [default to False]
...
```python
from kubernetes_asyncio_pydantic.models.v1_subject_access_review_status import V1SubjectAccessReviewStatus
