...
```python
from kubernetes_asyncio.models.v1alpha1_audit_annotation import V1alpha1AuditAnnotation
...
v1alpha1_audit_annotation_from_dict = V1alpha1AuditAnnotation.from_dict(v1alpha1_audit_annotation_dict)
```
