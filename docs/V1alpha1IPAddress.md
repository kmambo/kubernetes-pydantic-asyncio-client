...
**spec** | [**V1alpha1IPAddressSpec**](V1alpha1IPAddressSpec.md) | spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status | [optional] 
...
v1alpha1_ip_address_from_dict = V1alpha1IPAddress.from_dict(v1alpha1_ip_address_dict)
```
