...
**spec** | [**V1alpha1LeaseCandidateSpec**](V1alpha1LeaseCandidateSpec.md) | spec contains the specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status | [optional] 
