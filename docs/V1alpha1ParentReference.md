...
```python
from kubernetes_asyncio.models.v1alpha1_parent_reference import V1alpha1ParentReference
...
v1alpha1_parent_reference_from_dict = V1alpha1ParentReference.from_dict(v1alpha1_parent_reference_dict)
```
