...
v1alpha1_pod_certificate_request_spec_instance = V1alpha1PodCertificateRequestSpec.from_json(json)
# print the JSON string representation of the object
print(V1alpha1PodCertificateRequestSpec.to_json())

# convert the object into a dict
v1alpha1_pod_certificate_request_spec_dict = v1alpha1_pod_certificate_request_spec_instance.to_dict()
# create an instance of V1alpha1PodCertificateRequestSpec from a dict
v1alpha1_pod_certificate_request_spec_from_dict = V1alpha1PodCertificateRequestSpec.from_dict(v1alpha1_pod_certificate_request_spec_dict)
```
