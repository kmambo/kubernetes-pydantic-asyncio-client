...
```python
from kubernetes_asyncio.models.v1alpha1_service_cidr_spec import V1alpha1ServiceCIDRSpec
...
v1alpha1_service_cidr_spec_from_dict = V1alpha1ServiceCIDRSpec.from_dict(v1alpha1_service_cidr_spec_dict)
```
