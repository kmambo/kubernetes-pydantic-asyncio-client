...
**type_checking** | [**V1alpha1TypeChecking**](V1alpha1TypeChecking.md) | The results of type checking for each expression. Presence of this field indicates the completion of the type checking. | [optional] 

## Example

```python
from kubernetes_asyncio.models.v1alpha1_validating_admission_policy_status import V1alpha1ValidatingAdmissionPolicyStatus
...
v1alpha1_validating_admission_policy_status_from_dict = V1alpha1ValidatingAdmissionPolicyStatus.from_dict(v1alpha1_validating_admission_policy_status_dict)
```
