...
------------ | ------------- | ------------- | -------------
**named_resources** | [**V1alpha2NamedResourcesAllocationResult**](V1alpha2NamedResourcesAllocationResult.md) | NamedResources describes the allocation result when using the named resources model. | [optional] 
...
```python
from kubernetes_asyncio.models.v1alpha2_driver_allocation_result import V1alpha2DriverAllocationResult
...
v1alpha2_driver_allocation_result_from_dict = V1alpha2DriverAllocationResult.from_dict(v1alpha2_driver_allocation_result_dict)
```
