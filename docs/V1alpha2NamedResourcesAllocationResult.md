...
------------ | ------------- | ------------- | -------------
**name** | **str** | Name is the name of the selected resource instance. | [default to '']

## Example

```python
from kubernetes_asyncio.models.v1alpha2_named_resources_allocation_result import V1alpha2NamedResourcesAllocationResult
...
v1alpha2_named_resources_allocation_result_from_dict = V1alpha2NamedResourcesAllocationResult.from_dict(v1alpha2_named_resources_allocation_result_dict)
```
