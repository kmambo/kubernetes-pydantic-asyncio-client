...
```python
from kubernetes_asyncio.models.v1alpha2_named_resources_filter import V1alpha2NamedResourcesFilter
...
v1alpha2_named_resources_filter_from_dict = V1alpha2NamedResourcesFilter.from_dict(v1alpha2_named_resources_filter_dict)
```
