...
```python
from kubernetes_asyncio.models.v1alpha2_named_resources_int_slice import V1alpha2NamedResourcesIntSlice
...
v1alpha2_named_resources_int_slice_from_dict = V1alpha2NamedResourcesIntSlice.from_dict(v1alpha2_named_resources_int_slice_dict)
```
