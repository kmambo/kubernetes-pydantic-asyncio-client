...
```python
from kubernetes_asyncio.models.v1alpha2_named_resources_string_slice import V1alpha2NamedResourcesStringSlice
...
v1alpha2_named_resources_string_slice_from_dict = V1alpha2NamedResourcesStringSlice.from_dict(v1alpha2_named_resources_string_slice_dict)
```
