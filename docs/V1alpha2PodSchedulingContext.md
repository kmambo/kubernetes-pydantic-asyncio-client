...
**spec** | [**V1alpha2PodSchedulingContextSpec**](V1alpha2PodSchedulingContextSpec.md) | Spec describes where resources for the Pod are needed. | 
**status** | [**V1alpha2PodSchedulingContextStatus**](V1alpha2PodSchedulingContextStatus.md) | Status describes where resources for the Pod can be allocated. | [optional] 
...
v1alpha2_pod_scheduling_context_from_dict = V1alpha2PodSchedulingContext.from_dict(v1alpha2_pod_scheduling_context_dict)
```
