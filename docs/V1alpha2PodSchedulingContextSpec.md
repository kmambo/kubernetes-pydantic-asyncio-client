...
```python
from kubernetes_asyncio.models.v1alpha2_pod_scheduling_context_spec import V1alpha2PodSchedulingContextSpec
...
v1alpha2_pod_scheduling_context_spec_from_dict = V1alpha2PodSchedulingContextSpec.from_dict(v1alpha2_pod_scheduling_context_spec_dict)
```
