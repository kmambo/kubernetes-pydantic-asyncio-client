...
```python
from kubernetes_asyncio.models.v1alpha2_pod_scheduling_context_status import V1alpha2PodSchedulingContextStatus
...
v1alpha2_pod_scheduling_context_status_from_dict = V1alpha2PodSchedulingContextStatus.from_dict(v1alpha2_pod_scheduling_context_status_dict)
```
