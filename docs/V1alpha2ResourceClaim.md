...
**spec** | [**V1alpha2ResourceClaimSpec**](V1alpha2ResourceClaimSpec.md) | Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim. | 
**status** | [**V1alpha2ResourceClaimStatus**](V1alpha2ResourceClaimStatus.md) | Status describes whether the resource is available and with which attributes. | [optional] 
...
v1alpha2_resource_claim_from_dict = V1alpha2ResourceClaim.from_dict(v1alpha2_resource_claim_dict)
```
