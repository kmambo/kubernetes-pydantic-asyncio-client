...
```python
from kubernetes_asyncio.models.v1alpha2_resource_claim_consumer_reference import V1alpha2ResourceClaimConsumerReference
...
v1alpha2_resource_claim_consumer_reference_from_dict = V1alpha2ResourceClaimConsumerReference.from_dict(v1alpha2_resource_claim_consumer_reference_dict)
```
