...
**generated_from** | [**V1alpha2ResourceClaimParametersReference**](V1alpha2ResourceClaimParametersReference.md) | If this object was created from some other resource, then this links back to that resource. This field is used to find the in-tree representation of the claim parameters when the parameter reference of the claim refers to some unknown type. | [optional] 
...
v1alpha2_resource_claim_parameters_from_dict = V1alpha2ResourceClaimParameters.from_dict(v1alpha2_resource_claim_parameters_dict)
```
