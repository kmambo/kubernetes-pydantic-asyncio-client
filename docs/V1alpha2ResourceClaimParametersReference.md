...
**kind** | **str** | Kind is the type of resource being referenced. This is the same value as in the parameter object&#39;s metadata, for example \&quot;ConfigMap\&quot;. | [default to '']
**name** | **str** | Name is the name of resource being referenced. | [default to '']

## Example

```python
from kubernetes_asyncio.models.v1alpha2_resource_claim_parameters_reference import V1alpha2ResourceClaimParametersReference
...
v1alpha2_resource_claim_parameters_reference_from_dict = V1alpha2ResourceClaimParametersReference.from_dict(v1alpha2_resource_claim_parameters_reference_dict)
```
