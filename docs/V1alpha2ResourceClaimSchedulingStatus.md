...
```python
from kubernetes_asyncio.models.v1alpha2_resource_claim_scheduling_status import V1alpha2ResourceClaimSchedulingStatus
...
v1alpha2_resource_claim_scheduling_status_from_dict = V1alpha2ResourceClaimSchedulingStatus.from_dict(v1alpha2_resource_claim_scheduling_status_dict)
```
