...
**parameters_ref** | [**V1alpha2ResourceClaimParametersReference**](V1alpha2ResourceClaimParametersReference.md) | ParametersRef references a separate object with arbitrary parameters that will be used by the driver when allocating a resource for the claim.  The object must be in the same namespace as the ResourceClaim. | [optional] 
**resource_class_name** | **str** | ResourceClassName references the driver and additional parameters via the name of a ResourceClass that was created as part of the driver deployment. | [default to '']

## Example

```python
from kubernetes_asyncio.models.v1alpha2_resource_claim_spec import V1alpha2ResourceClaimSpec
...
v1alpha2_resource_claim_spec_from_dict = V1alpha2ResourceClaimSpec.from_dict(v1alpha2_resource_claim_spec_dict)
```
