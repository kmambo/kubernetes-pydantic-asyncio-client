...
------------ | ------------- | ------------- | -------------
**allocation** | [**V1alpha2AllocationResult**](V1alpha2AllocationResult.md) | Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet. | [optional] 
...
```python
from kubernetes_asyncio.models.v1alpha2_resource_claim_status import V1alpha2ResourceClaimStatus
...
v1alpha2_resource_claim_status_from_dict = V1alpha2ResourceClaimStatus.from_dict(v1alpha2_resource_claim_status_dict)
```
