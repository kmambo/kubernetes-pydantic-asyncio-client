...
**kind** | **str** | Kind is the type of resource being referenced. This is the same value as in the parameter object&#39;s metadata. | [default to '']
...
```python
from kubernetes_asyncio.models.v1alpha2_resource_class_parameters_reference import V1alpha2ResourceClassParametersReference
...
v1alpha2_resource_class_parameters_reference_from_dict = V1alpha2ResourceClassParametersReference.from_dict(v1alpha2_resource_class_parameters_reference_dict)
```
