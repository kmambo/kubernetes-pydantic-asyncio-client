...
**structured_data** | [**V1alpha2StructuredResourceHandle**](V1alpha2StructuredResourceHandle.md) | If StructuredData is set, then it needs to be used instead of Data. | [optional] 
...
v1alpha2_resource_handle_from_dict = V1alpha2ResourceHandle.from_dict(v1alpha2_resource_handle_dict)
```
