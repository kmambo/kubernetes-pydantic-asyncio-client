...
------------ | ------------- | ------------- | -------------
**named_resources** | [**V1alpha2NamedResourcesRequest**](V1alpha2NamedResourcesRequest.md) | NamedResources describes a request for resources with the named resources model. | [optional] 
...
```python
from kubernetes_asyncio.models.v1alpha2_resource_request import V1alpha2ResourceRequest
...
v1alpha2_resource_request_from_dict = V1alpha2ResourceRequest.from_dict(v1alpha2_resource_request_dict)
```
