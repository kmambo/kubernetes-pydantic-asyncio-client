...
```python
from kubernetes_asyncio.models.v1alpha2_vendor_parameters import V1alpha2VendorParameters
...
v1alpha2_vendor_parameters_from_dict = V1alpha2VendorParameters.from_dict(v1alpha2_vendor_parameters_dict)
```
