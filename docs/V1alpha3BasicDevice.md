...
**node_selector** | [**V1NodeSelector**](V1NodeSelector.md) | NodeSelector defines the nodes where the device is available.  Must only be set if Spec.PerDeviceNodeSelection is set to true. At most one of NodeName, NodeSelector and AllNodes can be set. | [optional] 
...
```python
from kubernetes_asyncio.models.v1alpha3_basic_device import V1alpha3BasicDevice
