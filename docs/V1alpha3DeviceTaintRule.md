...
**spec** | [**V1alpha3DeviceTaintRuleSpec**](V1alpha3DeviceTaintRuleSpec.md) | Spec specifies the selector and one taint.  Changing the spec automatically increments the metadata.generation number. | 
