...
json = "{}"
# create an instance of V1beta1ApplyConfiguration from a JSON string
v1beta1_apply_configuration_instance = V1beta1ApplyConfiguration.from_json(json)
# print the JSON string representation of the object
print(V1beta1ApplyConfiguration.to_json())

# convert the object into a dict
v1beta1_apply_configuration_dict = v1beta1_apply_configuration_instance.to_dict()
# create an instance of V1beta1ApplyConfiguration from a dict
v1beta1_apply_configuration_from_dict = V1beta1ApplyConfiguration.from_dict(v1beta1_apply_configuration_dict)
```
