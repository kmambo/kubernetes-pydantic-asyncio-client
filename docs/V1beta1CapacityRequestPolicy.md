...
v1beta1_capacity_request_policy_instance = V1beta1CapacityRequestPolicy.from_json(json)
# print the JSON string representation of the object
print(V1beta1CapacityRequestPolicy.to_json())

# convert the object into a dict
v1beta1_capacity_request_policy_dict = v1beta1_capacity_request_policy_instance.to_dict()
# create an instance of V1beta1CapacityRequestPolicy from a dict
v1beta1_capacity_request_policy_from_dict = V1beta1CapacityRequestPolicy.from_dict(v1beta1_capacity_request_policy_dict)
```
