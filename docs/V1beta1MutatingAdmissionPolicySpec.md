...
```python
from kubernetes_asyncio_pydantic.models.v1beta1_mutating_admission_policy_spec import V1beta1MutatingAdmissionPolicySpec

# TODO update the JSON string below
json = "{}"
# create an instance of V1beta1MutatingAdmissionPolicySpec from a JSON string
v1beta1_mutating_admission_policy_spec_instance = V1beta1MutatingAdmissionPolicySpec.from_json(json)
# print the JSON string representation of the object
print(V1beta1MutatingAdmissionPolicySpec.to_json())

# convert the object into a dict
v1beta1_mutating_admission_policy_spec_dict = v1beta1_mutating_admission_policy_spec_instance.to_dict()
# create an instance of V1beta1MutatingAdmissionPolicySpec from a dict
v1beta1_mutating_admission_policy_spec_from_dict = V1beta1MutatingAdmissionPolicySpec.from_dict(v1beta1_mutating_admission_policy_spec_dict)
```
