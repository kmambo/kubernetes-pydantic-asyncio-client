...
**network_data** | [**V1beta2NetworkDeviceData**](V1beta2NetworkDeviceData.md) | NetworkData contains network-related information specific to the device. | [optional] 
...
```python
from kubernetes_asyncio_pydantic.models.v1beta2_allocated_device_status import V1beta2AllocatedDeviceStatus
