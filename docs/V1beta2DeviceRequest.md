...
------------ | ------------- | ------------- | -------------
**exactly** | [**V1beta2ExactDeviceRequest**](V1beta2ExactDeviceRequest.md) | Exactly specifies the details for a single request that must be met exactly for the request to be satisfied.  One of Exactly or FirstAvailable must be set. | [optional] 
