...
------------ | ------------- | ------------- | -------------
**allocation** | [**V1beta2AllocationResult**](V1beta2AllocationResult.md) | Allocation is set once the claim has been allocated successfully. | [optional] 
...
```python
from kubernetes_asyncio_pydantic.models.v1beta2_resource_claim_status import V1beta2ResourceClaimStatus
