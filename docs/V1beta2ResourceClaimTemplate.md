...
**spec** | [**V1beta2ResourceClaimTemplateSpec**](V1beta2ResourceClaimTemplateSpec.md) | Describes the ResourceClaim that is to be generated.  This field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed and then not get updated anymore. | 
