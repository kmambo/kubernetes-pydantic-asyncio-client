...
v1beta3_limited_priority_level_configuration_from_dict = V1beta3LimitedPriorityLevelConfiguration.from_dict(v1beta3_limited_priority_level_configuration_dict)
```
