...
```python
from kubernetes_asyncio.models.v1beta3_priority_level_configuration_reference import V1beta3PriorityLevelConfigurationReference
...
v1beta3_priority_level_configuration_reference_from_dict = V1beta3PriorityLevelConfigurationReference.from_dict(v1beta3_priority_level_configuration_reference_dict)
```
