...
class ApiregistrationV1Api:
    ...
    async def create_api_service(
        ...
        :param v1_api_service: (required)
        :type v1_api_service: V1APIService
    ...
    @validate_call
    async def create_api_service_with_http_info(
        self,
        v1_api_service: V1APIService,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_api_service_without_preload_content(
        self,
        v1_api_service: V1APIService,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_api_service_serialize(
        ...
        if v1_api_service is not None:
            _body_params = v1_api_service
    ...
    async def delete_api_service(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
                description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget)."
    ...
    @validate_call
    async def delete_api_service_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def delete_api_service_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def delete_collection_api_service(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_api_service_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_api_service_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_api_service_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_api_service_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_api_service_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        body: Dict[str, Any],
        pretty: Annotated[
    ...
    @validate_call
    async def patch_api_service_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        body: Dict[str, Any],
        pretty: Annotated[
    ...
    @validate_call
    async def patch_api_service_status(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        body: Dict[str, Any],
        pretty: Annotated[
    ...
    @validate_call
    async def patch_api_service_status_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        body: Dict[str, Any],
        pretty: Annotated[
    ...
    @validate_call
    async def patch_api_service_status_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        body: Dict[str, Any],
        pretty: Annotated[
    ...
    @validate_call
    async def read_api_service_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def read_api_service_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def read_api_service_status(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def read_api_service_status_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def read_api_service_status_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def replace_api_service_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        v1_api_service: V1APIService,
        pretty: Annotated[
    ...
    @validate_call
    async def replace_api_service_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        v1_api_service: V1APIService,
        pretty: Annotated[
    ...
    @validate_call
    async def replace_api_service_status(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        v1_api_service: V1APIService,
        pretty: Annotated[
    ...
    @validate_call
    async def replace_api_service_status_with_http_info(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        v1_api_service: V1APIService,
        pretty: Annotated[
    ...
    @validate_call
    async def replace_api_service_status_without_preload_content(
        self,
        name: Annotated[str, Field(strict=True, description="name of the APIService")],
        v1_api_service: V1APIService,
        pretty: Annotated[
