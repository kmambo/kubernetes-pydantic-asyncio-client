...
class AuthenticationV1Api:
    ...
    async def create_self_subject_review(
        self,
        v1_self_subject_review: V1SelfSubjectReview,
        dry_run: Annotated[
        ...
        :param v1_self_subject_review: (required)
        :type v1_self_subject_review: V1SelfSubjectReview
        ...
        _param = self._create_self_subject_review_serialize(
            v1_self_subject_review=v1_self_subject_review,
            dry_run=dry_run,
    ...
    def _create_self_subject_review_serialize(
        ...
        if v1_self_subject_review is not None:
            _body_params = v1_self_subject_review
    ...
    async def create_token_review(
        ...
        :param v1_token_review: (required)
        :type v1_token_review: V1TokenReview
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        :param field_manager: fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
        :type field_manager: str
        ...
        _param = self._create_token_review_serialize(
            v1_token_review=v1_token_review,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
            pretty=pretty,
    ...
    @validate_call
    async def create_token_review_with_http_info(
        self,
        v1_token_review: V1TokenReview,
        dry_run: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_token_review_without_preload_content(
        self,
        v1_token_review: V1TokenReview,
        dry_run: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_token_review_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if v1_token_review is not None:
            _body_params = v1_token_review
