...
from kubernetes_asyncio.models.v1alpha1_self_subject_review import (
...
class AuthenticationV1alpha1Api:
    ...
    async def create_self_subject_review(
        self,
        v1alpha1_self_subject_review: V1alpha1SelfSubjectReview,
        dry_run: Annotated[
        ...
        :param v1alpha1_self_subject_review: (required)
        :type v1alpha1_self_subject_review: V1alpha1SelfSubjectReview
        ...
        _param = self._create_self_subject_review_serialize(
            v1alpha1_self_subject_review=v1alpha1_self_subject_review,
            dry_run=dry_run,
    ...
    def _create_self_subject_review_serialize(
        ...
        if v1alpha1_self_subject_review is not None:
            _body_params = v1alpha1_self_subject_review
