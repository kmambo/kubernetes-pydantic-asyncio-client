...
class CertificatesV1alpha1Api:
    ...
    async def create_cluster_trust_bundle(
        self,
        v1alpha1_cluster_trust_bundle: V1alpha1ClusterTrustBundle,
        pretty: Annotated[
        ...
        :param v1alpha1_cluster_trust_bundle: (required)
        :type v1alpha1_cluster_trust_bundle: V1alpha1ClusterTrustBundle
        ...
        _param = self._create_cluster_trust_bundle_serialize(
            v1alpha1_cluster_trust_bundle=v1alpha1_cluster_trust_bundle,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_cluster_trust_bundle_with_http_info(
        self,
        v1alpha1_cluster_trust_bundle: V1alpha1ClusterTrustBundle,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_cluster_trust_bundle_without_preload_content(
        self,
        v1alpha1_cluster_trust_bundle: V1alpha1ClusterTrustBundle,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_cluster_trust_bundle_serialize(
        ...
        if v1alpha1_cluster_trust_bundle is not None:
            _body_params = v1alpha1_cluster_trust_bundle
    ...
    async def delete_cluster_trust_bundle(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_cluster_trust_bundle_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def delete_cluster_trust_bundle_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def delete_collection_cluster_trust_bundle_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_cluster_trust_bundle_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_cluster_trust_bundle_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_cluster_trust_bundle_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_cluster_trust_bundle_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def patch_cluster_trust_bundle_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def read_cluster_trust_bundle_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def read_cluster_trust_bundle_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def replace_cluster_trust_bundle_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
    ...
    @validate_call
    async def replace_cluster_trust_bundle_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the ClusterTrustBundle")
        ],
