...
from kubernetes_asyncio.models.v1alpha1_lease_candidate_list import (
...
class CoordinationV1alpha1Api:
    ...
    @validate_call
    async def create_namespaced_lease_candidate(
        self,
        namespace: Annotated[
            str,
            Field(
        ...
        v1alpha1_lease_candidate: V1alpha1LeaseCandidate,
        pretty: Annotated[
        ...
        :type namespace: str
        :param v1alpha1_lease_candidate: (required)
        :type v1alpha1_lease_candidate: V1alpha1LeaseCandidate
        ...
        _param = self._create_namespaced_lease_candidate_serialize(
            namespace=namespace,
            v1alpha1_lease_candidate=v1alpha1_lease_candidate,
            pretty=pretty,
            dry_run=dry_run,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "V1alpha1LeaseCandidate",
            "201": "V1alpha1LeaseCandidate",
            "202": "V1alpha1LeaseCandidate",
            "401": None,
        }
    ...
    @validate_call
    async def create_namespaced_lease_candidate_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1LeaseCandidate]:
        """create_namespaced_lease_candidate
    ...
    @validate_call
    async def create_namespaced_lease_candidate_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    def _create_namespaced_lease_candidate_serialize(
        ...
        if v1alpha1_lease_candidate is not None:
            _body_params = v1alpha1_lease_candidate
    ...
    @validate_call
    async def delete_collection_namespaced_lease_candidate(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_collection_namespaced_lease_candidate_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_collection_namespaced_lease_candidate_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_namespaced_lease_candidate(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_namespaced_lease_candidate_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def delete_namespaced_lease_candidate_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def list_lease_candidate_for_all_namespaces(
        self,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "V1alpha1LeaseCandidateList",
            "401": None,
        }
        response_data = await self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    @validate_call
    async def list_lease_candidate_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[
            Optional[StrictBool],
            Field(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1LeaseCandidateList]:
        """list_lease_candidate_for_all_namespaces
    ...
    @validate_call
    async def list_lease_candidate_for_all_namespaces_without_preload_content(
        self,
        allow_watch_bookmarks: Annotated[
            Optional[StrictBool],
            Field(
    ...
    @validate_call
    async def list_namespaced_lease_candidate(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def list_namespaced_lease_candidate_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def list_namespaced_lease_candidate_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def patch_namespaced_lease_candidate(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def patch_namespaced_lease_candidate_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def patch_namespaced_lease_candidate_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def read_namespaced_lease_candidate(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def read_namespaced_lease_candidate_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def read_namespaced_lease_candidate_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def replace_namespaced_lease_candidate(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def replace_namespaced_lease_candidate_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
    ...
    @validate_call
    async def replace_namespaced_lease_candidate_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the LeaseCandidate")
        ],
