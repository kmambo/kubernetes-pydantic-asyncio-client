...
class CoordinationV1alpha2Api:
    ...
    async def create_namespaced_lease_candidate(
        ...
        v1alpha2_lease_candidate: V1alpha2LeaseCandidate,
        pretty: Annotated[
        ...
        :type namespace: str
        :param v1alpha2_lease_candidate: (required)
        :type v1alpha2_lease_candidate: V1alpha2LeaseCandidate
        ...
        _param = self._create_namespaced_lease_candidate_serialize(
            namespace=namespace,
            v1alpha2_lease_candidate=v1alpha2_lease_candidate,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def _create_namespaced_lease_candidate_serialize(
        ...
        if v1alpha2_lease_candidate is not None:
            _body_params = v1alpha2_lease_candidate
