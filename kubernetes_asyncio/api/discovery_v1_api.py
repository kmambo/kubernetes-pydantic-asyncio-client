...
class DiscoveryV1Api:
    ...
    async def create_namespaced_endpoint_slice(
        ...
        v1_endpoint_slice: V1EndpointSlice,
        pretty: Annotated[
        ...
        :type namespace: str
        :param v1_endpoint_slice: (required)
        :type v1_endpoint_slice: V1EndpointSlice
        ...
        _param = self._create_namespaced_endpoint_slice_serialize(
            namespace=namespace,
            v1_endpoint_slice=v1_endpoint_slice,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_namespaced_endpoint_slice_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def create_namespaced_endpoint_slice_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    def _create_namespaced_endpoint_slice_serialize(
        ...
        if v1_endpoint_slice is not None:
            _body_params = v1_endpoint_slice
    ...
    @validate_call
    async def delete_collection_namespaced_endpoint_slice_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_collection_namespaced_endpoint_slice_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_namespaced_endpoint_slice(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def delete_namespaced_endpoint_slice_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def delete_namespaced_endpoint_slice_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def list_endpoint_slice_for_all_namespaces_with_http_info(
        self,
        allow_watch_bookmarks: Annotated[
            Optional[StrictBool],
            Field(
    ...
    @validate_call
    async def list_endpoint_slice_for_all_namespaces_without_preload_content(
        self,
        allow_watch_bookmarks: Annotated[
            Optional[StrictBool],
            Field(
    ...
    @validate_call
    async def list_namespaced_endpoint_slice_with_http_info(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def list_namespaced_endpoint_slice_without_preload_content(
        self,
        namespace: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def patch_namespaced_endpoint_slice_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def patch_namespaced_endpoint_slice_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def read_namespaced_endpoint_slice(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def read_namespaced_endpoint_slice_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def read_namespaced_endpoint_slice_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def replace_namespaced_endpoint_slice_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
    ...
    @validate_call
    async def replace_namespaced_endpoint_slice_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the EndpointSlice")
        ],
