...
class FlowcontrolApiserverV1Api:
    ...
    async def create_flow_schema(
        ...
        :param v1_flow_schema: (required)
        :type v1_flow_schema: V1FlowSchema
    ...
    def _create_flow_schema_serialize(
        ...
        if v1_flow_schema is not None:
            _body_params = v1_flow_schema
    ...
    async def create_priority_level_configuration(
        self,
        v1_priority_level_configuration: V1PriorityLevelConfiguration,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
                description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget)."
        ...
        :param v1_priority_level_configuration: (required)
        :type v1_priority_level_configuration: V1PriorityLevelConfiguration
        :param pretty: If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
        :type pretty: str
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        ...
        _param = self._create_priority_level_configuration_serialize(
            v1_priority_level_configuration=v1_priority_level_configuration,
            pretty=pretty,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    def _create_priority_level_configuration_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if v1_priority_level_configuration is not None:
            _body_params = v1_priority_level_configuration
