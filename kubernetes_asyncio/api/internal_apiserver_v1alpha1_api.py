...
class InternalApiserverV1alpha1Api:
    ...
    async def create_storage_version(
        self,
        v1alpha1_storage_version: V1alpha1StorageVersion,
        pretty: Annotated[
        ...
        :param v1alpha1_storage_version: (required)
        :type v1alpha1_storage_version: V1alpha1StorageVersion
        ...
        _param = self._create_storage_version_serialize(
            v1alpha1_storage_version=v1alpha1_storage_version,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_storage_version_with_http_info(
        self,
        v1alpha1_storage_version: V1alpha1StorageVersion,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_storage_version_without_preload_content(
        self,
        v1alpha1_storage_version: V1alpha1StorageVersion,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_storage_version_serialize(
        ...
        if v1alpha1_storage_version is not None:
            _body_params = v1alpha1_storage_version
    ...
    @validate_call
    async def delete_collection_storage_version_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_storage_version_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    async def delete_storage_version(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_storage_version_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def delete_storage_version_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def list_storage_version_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_storage_version_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_storage_version_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def patch_storage_version_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def patch_storage_version_status_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def patch_storage_version_status_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def read_storage_version_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def read_storage_version_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def read_storage_version_status_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def read_storage_version_status_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def replace_storage_version_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def replace_storage_version_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def replace_storage_version_status_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
    ...
    @validate_call
    async def replace_storage_version_status_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the StorageVersion")
        ],
