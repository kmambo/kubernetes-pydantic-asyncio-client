...
class NetworkingV1beta1Api:
    ...
    async def create_ip_address(
        self,
        v1beta1_ip_address: V1beta1IPAddress,
        pretty: Annotated[
        ...
        :param v1beta1_ip_address: (required)
        :type v1beta1_ip_address: V1beta1IPAddress
        ...
        _param = self._create_ip_address_serialize(
            v1beta1_ip_address=v1beta1_ip_address,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def _create_ip_address_serialize(
        ...
        if v1beta1_ip_address is not None:
            _body_params = v1beta1_ip_address
    ...
    async def create_service_cidr(
        self,
        v1beta1_service_cidr: V1beta1ServiceCIDR,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
                description="If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget)."
        ...
        :param v1beta1_service_cidr: (required)
        :type v1beta1_service_cidr: V1beta1ServiceCIDR
        :param pretty: If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
        :type pretty: str
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        ...
        _param = self._create_service_cidr_serialize(
            v1beta1_service_cidr=v1beta1_service_cidr,
            pretty=pretty,
            dry_run=dry_run,
            field_manager=field_manager,
            field_validation=field_validation,
    ...
    def _create_service_cidr_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if v1beta1_service_cidr is not None:
            _body_params = v1beta1_service_cidr
