...
class NodeV1Api:
    ...
    @validate_call
    async def create_runtime_class(
        self,
        v1_runtime_class: V1RuntimeClass,
        pretty: Annotated[
        ...
        :param v1_runtime_class: (required)
        :type v1_runtime_class: V1RuntimeClass
        ...
        _param = self._create_runtime_class_serialize(
            v1_runtime_class=v1_runtime_class,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_runtime_class_with_http_info(
        self,
        v1_runtime_class: V1RuntimeClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_runtime_class_without_preload_content(
        self,
        v1_runtime_class: V1RuntimeClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_runtime_class_serialize(
        ...
        if v1_runtime_class is not None:
            _body_params = v1_runtime_class
    ...
    @validate_call
    async def delete_collection_runtime_class(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_runtime_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_runtime_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_runtime_class(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_runtime_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def delete_runtime_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def list_runtime_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_runtime_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_runtime_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def patch_runtime_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def read_runtime_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def read_runtime_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def replace_runtime_class(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def replace_runtime_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
    ...
    @validate_call
    async def replace_runtime_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the RuntimeClass")
        ],
