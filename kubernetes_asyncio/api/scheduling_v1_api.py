...
class SchedulingV1Api:
    ...
    async def create_priority_class(
        self,
        v1_priority_class: V1PriorityClass,
        pretty: Annotated[
        ...
        :param v1_priority_class: (required)
        :type v1_priority_class: V1PriorityClass
        ...
        _param = self._create_priority_class_serialize(
            v1_priority_class=v1_priority_class,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_priority_class_with_http_info(
        self,
        v1_priority_class: V1PriorityClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_priority_class_without_preload_content(
        self,
        v1_priority_class: V1PriorityClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_priority_class_serialize(
        ...
        if v1_priority_class is not None:
            _body_params = v1_priority_class
    ...
    @validate_call
    async def delete_collection_priority_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_priority_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    async def delete_priority_class(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_priority_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def delete_priority_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def list_priority_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_priority_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_priority_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def patch_priority_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def read_priority_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def read_priority_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def replace_priority_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
    ...
    @validate_call
    async def replace_priority_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the PriorityClass")
        ],
