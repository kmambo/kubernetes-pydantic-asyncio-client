...
class StorageV1alpha1Api:
    ...
    async def create_volume_attributes_class(
        self,
        v1alpha1_volume_attributes_class: V1alpha1VolumeAttributesClass,
        pretty: Annotated[
        ...
        :param v1alpha1_volume_attributes_class: (required)
        :type v1alpha1_volume_attributes_class: V1alpha1VolumeAttributesClass
        ...
        _param = self._create_volume_attributes_class_serialize(
            v1alpha1_volume_attributes_class=v1alpha1_volume_attributes_class,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    async def create_volume_attributes_class_with_http_info(
        self,
        v1alpha1_volume_attributes_class: V1alpha1VolumeAttributesClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    @validate_call
    async def create_volume_attributes_class_without_preload_content(
        self,
        v1alpha1_volume_attributes_class: V1alpha1VolumeAttributesClass,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_volume_attributes_class_serialize(
        ...
        if v1alpha1_volume_attributes_class is not None:
            _body_params = v1alpha1_volume_attributes_class
    ...
    @validate_call
    async def delete_collection_volume_attributes_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_collection_volume_attributes_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    async def delete_volume_attributes_class(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def delete_volume_attributes_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def delete_volume_attributes_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def list_volume_attributes_class_with_http_info(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def list_volume_attributes_class_without_preload_content(
        self,
        pretty: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
            Field(
    ...
    @validate_call
    async def patch_volume_attributes_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def patch_volume_attributes_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def read_volume_attributes_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def read_volume_attributes_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def replace_volume_attributes_class_with_http_info(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
    ...
    @validate_call
    async def replace_volume_attributes_class_without_preload_content(
        self,
        name: Annotated[
            str, Field(strict=True, description="name of the VolumeAttributesClass")
        ],
