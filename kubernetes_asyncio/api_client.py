...
import kubernetes_asyncio.models
from kubernetes_asyncio import rest
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/1.30.14/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kubernetes_asyncio.models, klass)
