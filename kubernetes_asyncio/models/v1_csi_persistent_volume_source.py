...
class V1CSIPersistentVolumeSource(BaseModel):
    ...
    controller_publish_secret_ref: Optional[V1SecretReference] = Field(
        default=None,
    ...
    node_expand_secret_ref: Optional[V1SecretReference] = Field(
        default=None,
        description="nodeExpandSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodeExpandVolume call. This field is optional, may be omitted if no secret is required. If the secret object contains more than one secret, all secrets are passed.",
        alias="nodeExpandSecretRef",
    )
    node_publish_secret_ref: Optional[V1SecretReference] = Field(
        default=None,
        description="nodePublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodePublishVolume and NodeUnpublishVolume calls. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.",
        alias="nodePublishSecretRef",
    )
    node_stage_secret_ref: Optional[V1SecretReference] = Field(
        default=None,
    ...
    volume_attributes: Optional[Dict[str, StrictStr]] = Field(
        default=None,
        description="volumeAttributes of the volume to publish.",
        alias="volumeAttributes",
    )
    volume_handle: StrictStr = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.controller_expand_secret_ref:
            _dict["controllerExpandSecretRef"] = (
                self.controller_expand_secret_ref.to_dict()
            )
        ...
        if self.controller_publish_secret_ref:
            _dict["controllerPublishSecretRef"] = (
                self.controller_publish_secret_ref.to_dict()
            )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "controllerExpandSecretRef": (
                    V1SecretReference.from_dict(obj["controllerExpandSecretRef"])
                    if obj.get("controllerExpandSecretRef") is not None
                    else None
                ),
                "controllerPublishSecretRef": (
                    V1SecretReference.from_dict(obj["controllerPublishSecretRef"])
                    if obj.get("controllerPublishSecretRef") is not None
                    else None
                ),
                "driver": obj.get("driver") if obj.get("driver") is not None else "",
                "fsType": obj.get("fsType"),
                "nodeExpandSecretRef": (
                    V1SecretReference.from_dict(obj["nodeExpandSecretRef"])
                    if obj.get("nodeExpandSecretRef") is not None
                    else None
                ),
                "nodePublishSecretRef": (
                    V1SecretReference.from_dict(obj["nodePublishSecretRef"])
                    if obj.get("nodePublishSecretRef") is not None
                    else None
                ),
                "nodeStageSecretRef": (
                    V1SecretReference.from_dict(obj["nodeStageSecretRef"])
                    if obj.get("nodeStageSecretRef") is not None
                    else None
                ),
                "readOnly": obj.get("readOnly"),
                "volumeAttributes": obj.get("volumeAttributes"),
                "volumeHandle": (
                    obj.get("volumeHandle")
                    if obj.get("volumeHandle") is not None
                    else ""
                ),
            }
        )
