...
class V1EnvFromSource(BaseModel):
    ...
    config_map_ref: Optional[V1ConfigMapEnvSource] = Field(
        default=None, description="The ConfigMap to select from", alias="configMapRef"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "configMapRef": (
                    V1ConfigMapEnvSource.from_dict(obj["configMapRef"])
                    if obj.get("configMapRef") is not None
                    else None
                ),
                "prefix": obj.get("prefix"),
                "secretRef": (
                    V1SecretEnvSource.from_dict(obj["secretRef"])
