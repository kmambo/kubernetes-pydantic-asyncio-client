...
class V1ISCSIVolumeSource(BaseModel):
    ...
    chap_auth_discovery: Optional[StrictBool] = Field(
        default=None,
        description="chapAuthDiscovery defines whether support iSCSI Discovery CHAP authentication",
        alias="chapAuthDiscovery",
    )
    chap_auth_session: Optional[StrictBool] = Field(
        default=None,
    ...
    initiator_name: Optional[StrictStr] = Field(
        default=None,
    ...
    portals: Optional[List[StrictStr]] = Field(
        default=None,
    ...
    secret_ref: Optional[V1LocalObjectReference] = Field(
        default=None,
        description="secretRef is the CHAP Secret for iSCSI target and initiator authentication",
        alias="secretRef",
    )
    target_portal: StrictStr = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "secretRef": (
                    V1LocalObjectReference.from_dict(obj["secretRef"])
                    if obj.get("secretRef") is not None
                    else None
                ),
                "targetPortal": (
                    obj.get("targetPortal")
                    if obj.get("targetPortal") is not None
                    else ""
                ),
            }
        )
