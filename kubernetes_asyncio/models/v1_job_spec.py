...
class V1JobSpec(BaseModel):
    ...
    completion_mode: Optional[StrictStr] = Field(
        default=None,
    ...
    manual_selector: Optional[StrictBool] = Field(
        default=None,
    ...
    max_failed_indexes: Optional[StrictInt] = Field(
        default=None,
    ...
    pod_failure_policy: Optional[V1PodFailurePolicy] = Field(
        default=None,
    ...
    success_policy: Optional[V1SuccessPolicy] = Field(
        default=None,
        description="successPolicy specifies the policy when the Job can be declared as succeeded. If empty, the default behavior applies - the Job is declared as succeeded only when the number of succeeded pods equals to the completions. When the field is specified, it must be immutable and works only for the Indexed Jobs. Once the Job meets the SuccessPolicy, the lingering pods are terminated.  This field  is alpha-level. To use this field, you must enable the `JobSuccessPolicy` feature gate (disabled by default).",
        alias="successPolicy",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "podFailurePolicy": (
                    V1PodFailurePolicy.from_dict(obj["podFailurePolicy"])
                    if obj.get("podFailurePolicy") is not None
                    else None
                ),
                ...
                "successPolicy": (
                    V1SuccessPolicy.from_dict(obj["successPolicy"])
                    if obj.get("successPolicy") is not None
                    else None
                ),
