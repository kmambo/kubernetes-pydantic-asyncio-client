...
class V1NetworkPolicySpec(BaseModel):
    ...
    egress: Optional[List[V1NetworkPolicyEgressRule]] = Field(
        default=None,
    ...
    ingress: Optional[List[V1NetworkPolicyIngressRule]] = Field(
        default=None,
    ...
    policy_types: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "egress": (
                    [
                        V1NetworkPolicyEgressRule.from_dict(_item)
                        for _item in obj["egress"]
                    ]
                ...
                "ingress": (
                    [
                        V1NetworkPolicyIngressRule.from_dict(_item)
                        for _item in obj["ingress"]
                    ]
                    if obj.get("ingress") is not None
                    else None
                ),
                "podSelector": (
                    V1LabelSelector.from_dict(obj["podSelector"])
                    if obj.get("podSelector") is not None
                    else None
                ),
