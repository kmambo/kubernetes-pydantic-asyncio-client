...
class V1NodeStatus(BaseModel):
    ...
    daemon_endpoints: Optional[V1NodeDaemonEndpoints] = Field(
        default=None,
    ...
    runtime_handlers: Optional[List[V1NodeRuntimeHandler]] = Field(
        default=None,
        description="The available runtime handlers.",
        alias="runtimeHandlers",
    )
    volumes_attached: Optional[List[V1AttachedVolume]] = Field(
        default=None,
        description="List of volumes that are attached to the node.",
        alias="volumesAttached",
    )
    volumes_in_use: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        if self.allocatable:
            for _key_allocatable in self.allocatable:
                if self.allocatable[_key_allocatable]:
                    _field_dict[_key_allocatable] = self.allocatable[
                        _key_allocatable
                    ].to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "addresses": (
                    [V1NodeAddress.from_dict(_item) for _item in obj["addresses"]]
                ...
                "conditions": (
                    [V1NodeCondition.from_dict(_item) for _item in obj["conditions"]]
                    if obj.get("conditions") is not None
                    else None
                ),
                "config": (
                    V1NodeConfigStatus.from_dict(obj["config"])
                ...
                "images": (
                    [V1ContainerImage.from_dict(_item) for _item in obj["images"]]
                    if obj.get("images") is not None
                    else None
                ),
                "nodeInfo": (
                    V1NodeSystemInfo.from_dict(obj["nodeInfo"])
                ...
                "runtimeHandlers": (
                    [
                        V1NodeRuntimeHandler.from_dict(_item)
                        for _item in obj["runtimeHandlers"]
                    ]
                    if obj.get("runtimeHandlers") is not None
                    else None
                ),
                "volumesAttached": (
                    [
                        V1AttachedVolume.from_dict(_item)
                        for _item in obj["volumesAttached"]
                    ]
                    if obj.get("volumesAttached") is not None
                    else None
                ),
