...
class V1PersistentVolumeClaimSpec(BaseModel):
    ...
    data_source: Optional[V1TypedLocalObjectReference] = Field(
        default=None,
    ...
    data_source_ref: Optional[V1TypedObjectReference] = Field(
        default=None,
    ...
    volume_name: Optional[StrictStr] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "dataSource": (
                    V1TypedLocalObjectReference.from_dict(obj["dataSource"])
                    if obj.get("dataSource") is not None
                    else None
                ),
                "dataSourceRef": (
                    V1TypedObjectReference.from_dict(obj["dataSourceRef"])
                    if obj.get("dataSourceRef") is not None
                    else None
                ),
                "resources": (
                    V1VolumeResourceRequirements.from_dict(obj["resources"])
