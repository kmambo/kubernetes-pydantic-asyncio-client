...
class V1PersistentVolumeClaimStatus(BaseModel):
    ...
    allocated_resource_statuses: Optional[Dict[str, StrictStr]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "conditions": (
                    [
                        V1PersistentVolumeClaimCondition.from_dict(_item)
                        for _item in obj["conditions"]
                    ]
                    if obj.get("conditions") is not None
                    else None
                ),
                "currentVolumeAttributesClassName": obj.get(
                    "currentVolumeAttributesClassName"
                ),
                "modifyVolumeStatus": (
                    V1ModifyVolumeStatus.from_dict(obj["modifyVolumeStatus"])
                    if obj.get("modifyVolumeStatus") is not None
                    else None
                ),
                "phase": obj.get("phase"),
            }
