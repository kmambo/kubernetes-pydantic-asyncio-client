    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.preferred_during_scheduling_ignored_during_execution:
            for (
                _item_preferred_during_scheduling_ignored_during_execution
                ...
                if _item_preferred_during_scheduling_ignored_during_execution:
                    _items.append(
                        _item_preferred_during_scheduling_ignored_during_execution.to_dict()
                    )
        ...
        if self.required_during_scheduling_ignored_during_execution:
            for (
                _item_required_during_scheduling_ignored_during_execution
            ) in self.required_during_scheduling_ignored_during_execution:
                if _item_required_during_scheduling_ignored_during_execution:
                    _items.append(
                        _item_required_during_scheduling_ignored_during_execution.to_dict()
                    )
        ...
        _obj = cls.model_validate(
            {
                "preferredDuringSchedulingIgnoredDuringExecution": (
                    [
                        V1WeightedPodAffinityTerm.from_dict(_item)
                        for _item in obj[
                            "preferredDuringSchedulingIgnoredDuringExecution"
                        ]
                    ]
                    if obj.get("preferredDuringSchedulingIgnoredDuringExecution")
                    is not None
                    else None
                ),
                "requiredDuringSchedulingIgnoredDuringExecution": (
                    [
                        V1PodAffinityTerm.from_dict(_item)
                        for _item in obj[
                            "requiredDuringSchedulingIgnoredDuringExecution"
                        ]
                    ]
