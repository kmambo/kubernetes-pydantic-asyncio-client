...
class V1PodStatus(BaseModel):
    ...
    conditions: Optional[List[V1PodCondition]] = Field(
        default=None,
    ...
    ephemeral_container_statuses: Optional[List[V1ContainerStatus]] = Field(
        default=None,
    ...
    nominated_node_name: Optional[StrictStr] = Field(
        default=None,
    ...
    qos_class: Optional[StrictStr] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "conditions": (
                    [V1PodCondition.from_dict(_item) for _item in obj["conditions"]]
                    if obj.get("conditions") is not None
                    else None
                ),
                "containerStatuses": (
                    [
                        V1ContainerStatus.from_dict(_item)
                        for _item in obj["containerStatuses"]
                    ]
                    if obj.get("containerStatuses") is not None
                    else None
                ),
                "ephemeralContainerStatuses": (
                    [
                ...
                "hostIPs": (
                    ...
                    if obj.get("hostIPs") is not None
                    else None
                ),
                "initContainerStatuses": (
                    [
                        V1ContainerStatus.from_dict(_item)
                        for _item in obj["initContainerStatuses"]
                    ]
                    if obj.get("initContainerStatuses") is not None
                    else None
                ),
                ...
                "podIP": obj.get("podIP"),
                "podIPs": (
                    [V1PodIP.from_dict(_item) for _item in obj["podIPs"]]
                    if obj.get("podIPs") is not None
                    else None
                ),
                ...
                "resourceClaimStatuses": (
                    [
                        V1PodResourceClaimStatus.from_dict(_item)
                        for _item in obj["resourceClaimStatuses"]
                    ]
                    if obj.get("resourceClaimStatuses") is not None
                    else None
                ),
