...
class V1ScaleIOVolumeSource(BaseModel):
    ...
    gateway: StrictStr = Field(
        description="gateway is the host address of the ScaleIO API Gateway."
    )
    protection_domain: Optional[StrictStr] = Field(
        default=None,
    ...
    ssl_enabled: Optional[StrictBool] = Field(
        default=None,
    ...
    storage_pool: Optional[StrictStr] = Field(
        default=None,
        description="storagePool is the ScaleIO Storage Pool associated with the protection domain.",
        alias="storagePool",
    )
    system: StrictStr = Field(
