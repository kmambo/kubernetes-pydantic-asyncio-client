...
class V1SecurityContext(BaseModel):
    ...
    app_armor_profile: Optional[V1AppArmorProfile] = Field(
        default=None,
    ...
    se_linux_options: Optional[V1SELinuxOptions] = Field(
        default=None,
        description="The SELinux context to be applied to the container. If unspecified, the container runtime will allocate a random SELinux context for each container.  May also be set in PodSecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. Note that this field cannot be set when spec.os.name is windows.",
        alias="seLinuxOptions",
    )
    seccomp_profile: Optional[V1SeccompProfile] = Field(
        default=None,
        description="The seccomp options to use by this container. If seccomp options are provided at both the pod & container level, the container options override the pod options. Note that this field cannot be set when spec.os.name is windows.",
        alias="seccompProfile",
    )
    windows_options: Optional[V1WindowsSecurityContextOptions] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "appArmorProfile": (
                    V1AppArmorProfile.from_dict(obj["appArmorProfile"])
                    if obj.get("appArmorProfile") is not None
                    else None
                ),
                "capabilities": (
                    V1Capabilities.from_dict(obj["capabilities"])
                ...
                "seLinuxOptions": (
                    V1SELinuxOptions.from_dict(obj["seLinuxOptions"])
                    if obj.get("seLinuxOptions") is not None
                    else None
                ),
                "seccompProfile": (
                    V1SeccompProfile.from_dict(obj["seccompProfile"])
                    if obj.get("seccompProfile") is not None
                    else None
                ),
                "windowsOptions": (
                    V1WindowsSecurityContextOptions.from_dict(obj["windowsOptions"])
