...
class V1StatefulSetSpec(BaseModel):
    ...
    revision_history_limit: Optional[StrictInt] = Field(
        default=None,
    ...
    update_strategy: Optional[V1StatefulSetUpdateStrategy] = Field(
        default=None,
        description="updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.",
        alias="updateStrategy",
    )
    volume_claim_templates: Optional[List[V1PersistentVolumeClaim]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.persistent_volume_claim_retention_policy:
            _dict["persistentVolumeClaimRetentionPolicy"] = (
                self.persistent_volume_claim_retention_policy.to_dict()
            )
        ...
        _obj = cls.model_validate(
            {
                ...
                "ordinals": (
                    V1StatefulSetOrdinals.from_dict(obj["ordinals"])
                    if obj.get("ordinals") is not None
                    else None
                ),
                "persistentVolumeClaimRetentionPolicy": (
                    V1StatefulSetPersistentVolumeClaimRetentionPolicy.from_dict(
                        obj["persistentVolumeClaimRetentionPolicy"]
                    )
                    if obj.get("persistentVolumeClaimRetentionPolicy") is not None
                    else None
                ),
                ...
                "serviceName": (
                    obj.get("serviceName") if obj.get("serviceName") is not None else ""
                ),
                "template": (
                ...
                "updateStrategy": (
                    V1StatefulSetUpdateStrategy.from_dict(obj["updateStrategy"])
                    if obj.get("updateStrategy") is not None
                    else None
                ),
                "volumeClaimTemplates": (
                    [
                        V1PersistentVolumeClaim.from_dict(_item)
                        for _item in obj["volumeClaimTemplates"]
                    ]
                    if obj.get("volumeClaimTemplates") is not None
                    else None
                ),
            }
        )
