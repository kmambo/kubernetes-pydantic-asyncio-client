...
class V1Volume(BaseModel):
    ...
    azure_file: Optional[V1AzureFileVolumeSource] = Field(
        default=None,
    ...
    config_map: Optional[V1ConfigMapVolumeSource] = Field(
        default=None,
    ...
    downward_api: Optional[V1DownwardAPIVolumeSource] = Field(
        default=None,
        description="downwardAPI represents downward API about the pod that should populate this volume",
        alias="downwardAPI",
    )
    empty_dir: Optional[V1EmptyDirVolumeSource] = Field(
        default=None,
    ...
    flex_volume: Optional[V1FlexVolumeSource] = Field(
        default=None,
    ...
    git_repo: Optional[V1GitRepoVolumeSource] = Field(
        default=None,
    ...
    persistent_volume_claim: Optional[V1PersistentVolumeClaimVolumeSource] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "azureFile": (
                    V1AzureFileVolumeSource.from_dict(obj["azureFile"])
                    if obj.get("azureFile") is not None
                    else None
                ),
                "cephfs": (
                    V1CephFSVolumeSource.from_dict(obj["cephfs"])
                    if obj.get("cephfs") is not None
                    else None
                ),
                "cinder": (
                    V1CinderVolumeSource.from_dict(obj["cinder"])
                    if obj.get("cinder") is not None
                    else None
                ),
                "configMap": (
                    V1ConfigMapVolumeSource.from_dict(obj["configMap"])
                    if obj.get("configMap") is not None
                    else None
                ),
                "csi": (
                    V1CSIVolumeSource.from_dict(obj["csi"])
                    if obj.get("csi") is not None
                    else None
                ),
                "downwardAPI": (
                    V1DownwardAPIVolumeSource.from_dict(obj["downwardAPI"])
                    if obj.get("downwardAPI") is not None
                    else None
                ),
                "emptyDir": (
                    V1EmptyDirVolumeSource.from_dict(obj["emptyDir"])
                    if obj.get("emptyDir") is not None
                    else None
                ),
                "ephemeral": (
                    V1EphemeralVolumeSource.from_dict(obj["ephemeral"])
                ...
                "flexVolume": (
                    V1FlexVolumeSource.from_dict(obj["flexVolume"])
                ...
                "gitRepo": (
                    V1GitRepoVolumeSource.from_dict(obj["gitRepo"])
                    if obj.get("gitRepo") is not None
                    else None
                ),
                "glusterfs": (
                    V1GlusterfsVolumeSource.from_dict(obj["glusterfs"])
                ...
                "iscsi": (
                    V1ISCSIVolumeSource.from_dict(obj["iscsi"])
                ...
                "persistentVolumeClaim": (
                    V1PersistentVolumeClaimVolumeSource.from_dict(
                ...
                "projected": (
                    V1ProjectedVolumeSource.from_dict(obj["projected"])
                ...
                "rbd": (
                    V1RBDVolumeSource.from_dict(obj["rbd"])
                    if obj.get("rbd") is not None
                    else None
                ),
                "scaleIO": (
                    V1ScaleIOVolumeSource.from_dict(obj["scaleIO"])
                    if obj.get("scaleIO") is not None
                    else None
                ),
                "secret": (
                    V1SecretVolumeSource.from_dict(obj["secret"])
                    if obj.get("secret") is not None
                    else None
                ),
                "storageos": (
                    V1StorageOSVolumeSource.from_dict(obj["storageos"])
