...
class V1VolumeProjection(BaseModel):
    ...
    config_map: Optional[V1ConfigMapProjection] = Field(
        default=None,
        description="configMap information about the configMap data to project",
        alias="configMap",
    )
    downward_api: Optional[V1DownwardAPIProjection] = Field(
        default=None,
    ...
    service_account_token: Optional[V1ServiceAccountTokenProjection] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "clusterTrustBundle": (
                    V1ClusterTrustBundleProjection.from_dict(obj["clusterTrustBundle"])
                    if obj.get("clusterTrustBundle") is not None
                    else None
                ),
                "configMap": (
                    V1ConfigMapProjection.from_dict(obj["configMap"])
                    if obj.get("configMap") is not None
                    else None
                ),
                "downwardAPI": (
                    V1DownwardAPIProjection.from_dict(obj["downwardAPI"])
                    if obj.get("downwardAPI") is not None
                    else None
                ),
                "secret": (
                    V1SecretProjection.from_dict(obj["secret"])
                    if obj.get("secret") is not None
                    else None
                ),
                "serviceAccountToken": (
                    V1ServiceAccountTokenProjection.from_dict(
                        obj["serviceAccountToken"]
                    )
                    if obj.get("serviceAccountToken") is not None
                    else None
                ),
            }
        )
