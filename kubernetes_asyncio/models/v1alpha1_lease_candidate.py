...
from kubernetes_asyncio.models.v1alpha1_lease_candidate_spec import (
    V1alpha1LeaseCandidateSpec,
)


class V1alpha1LeaseCandidate(BaseModel):
    """
    ...
    spec: Optional[V1alpha1LeaseCandidateSpec] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha1LeaseCandidateSpec.from_dict(obj["spec"])
