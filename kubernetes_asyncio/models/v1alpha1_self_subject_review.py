...
from kubernetes_asyncio.models.v1alpha1_self_subject_review_status import (
    V1alpha1SelfSubjectReviewStatus,
)


class V1alpha1SelfSubjectReview(BaseModel):
    """
    ...
    status: Optional[V1alpha1SelfSubjectReviewStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "status": (
                    V1alpha1SelfSubjectReviewStatus.from_dict(obj["status"])
