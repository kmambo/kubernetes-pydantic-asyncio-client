...
from kubernetes_asyncio.models.v1alpha1_service_cidr_status import (
    V1alpha1ServiceCIDRStatus,
)


class V1alpha1ServiceCIDR(BaseModel):
    """
    ...
    spec: Optional[V1alpha1ServiceCIDRSpec] = Field(
        default=None,
    ...
    status: Optional[V1alpha1ServiceCIDRStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha1ServiceCIDRSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1alpha1ServiceCIDRStatus.from_dict(obj["status"])
