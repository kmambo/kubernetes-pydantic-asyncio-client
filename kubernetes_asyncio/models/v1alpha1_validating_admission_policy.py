...
from kubernetes_asyncio.models.v1alpha1_validating_admission_policy_spec import (
    V1alpha1ValidatingAdmissionPolicySpec,
)
from kubernetes_asyncio.models.v1alpha1_validating_admission_policy_status import (
    V1alpha1ValidatingAdmissionPolicyStatus,
)


class V1alpha1ValidatingAdmissionPolicy(BaseModel):
    """
    ...
    spec: Optional[V1alpha1ValidatingAdmissionPolicySpec] = Field(
        default=None,
        description="Specification of the desired behavior of the ValidatingAdmissionPolicy.",
    )
    status: Optional[V1alpha1ValidatingAdmissionPolicyStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha1ValidatingAdmissionPolicySpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1alpha1ValidatingAdmissionPolicyStatus.from_dict(obj["status"])
