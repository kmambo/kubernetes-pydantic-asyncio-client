...
from kubernetes_asyncio.models.v1alpha1_validating_admission_policy_binding_spec import (
    V1alpha1ValidatingAdmissionPolicyBindingSpec,
)


class V1alpha1ValidatingAdmissionPolicyBinding(BaseModel):
    """
    ...
    spec: Optional[V1alpha1ValidatingAdmissionPolicyBindingSpec] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha1ValidatingAdmissionPolicyBindingSpec.from_dict(obj["spec"])
