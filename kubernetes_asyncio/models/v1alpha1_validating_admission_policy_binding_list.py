...
class V1alpha1ValidatingAdmissionPolicyBindingList(BaseModel):
    """
    ...
    items: List[V1alpha1ValidatingAdmissionPolicyBinding] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha1ValidatingAdmissionPolicyBinding.from_dict(_item)
