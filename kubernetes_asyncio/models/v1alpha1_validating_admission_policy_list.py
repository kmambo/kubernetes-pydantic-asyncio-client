...
class V1alpha1ValidatingAdmissionPolicyList(BaseModel):
    """
    ...
    items: List[V1alpha1ValidatingAdmissionPolicy] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha1ValidatingAdmissionPolicy.from_dict(_item)
