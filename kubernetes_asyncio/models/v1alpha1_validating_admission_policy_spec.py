...
from kubernetes_asyncio.models.v1alpha1_validation import V1alpha1Validation
...
class V1alpha1ValidatingAdmissionPolicySpec(BaseModel):
    ...
    audit_annotations: Optional[List[V1alpha1AuditAnnotation]] = Field(
        default=None,
    ...
    validations: Optional[List[V1alpha1Validation]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "auditAnnotations": (
                    [
                        V1alpha1AuditAnnotation.from_dict(_item)
                        for _item in obj["auditAnnotations"]
                    ]
                    if obj.get("auditAnnotations") is not None
                    else None
                ),
                ...
                "validations": (
                    [
                        V1alpha1Validation.from_dict(_item)
                        for _item in obj["validations"]
                    ]
