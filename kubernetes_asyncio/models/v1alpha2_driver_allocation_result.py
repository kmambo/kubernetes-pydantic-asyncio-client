...
from kubernetes_asyncio.models.v1alpha2_named_resources_allocation_result import (
    V1alpha2NamedResourcesAllocationResult,
)


class V1alpha2DriverAllocationResult(BaseModel):
    """
    DriverAllocationResult contains vendor parameters and the allocation result for one request.
    """  # noqa: E501

    named_resources: Optional[V1alpha2NamedResourcesAllocationResult] = Field(
        default=None,
        description="NamedResources describes the allocation result when using the named resources model.",
        alias="namedResources",
    )
    vendor_request_parameters: Optional[Dict[str, Any]] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["namedResources", "vendorRequestParameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "namedResources": (
                    V1alpha2NamedResourcesAllocationResult.from_dict(
                        obj["namedResources"]
                    )
                    if obj.get("namedResources") is not None
                    else None
                ),
                "vendorRequestParameters": obj.get("vendorRequestParameters"),
            }
        )
        return _obj
