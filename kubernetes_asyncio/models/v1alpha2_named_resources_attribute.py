...
from kubernetes_asyncio.models.v1alpha2_named_resources_attribute_quantity import (
    V1alpha2NamedResourcesAttributeQuantity,
)
from kubernetes_asyncio.models.v1alpha2_named_resources_int_slice import (
    V1alpha2NamedResourcesIntSlice,
)
from kubernetes_asyncio.models.v1alpha2_named_resources_string_slice import (
...
class V1alpha2NamedResourcesAttribute(BaseModel):
    ...
    bool: Optional[StrictBool] = Field(
        default=None, description="BoolValue is a true/false value."
    )
    int: Optional[StrictInt] = Field(
        default=None, description="IntValue is a 64-bit integer."
    )
    int_slice: Optional[V1alpha2NamedResourcesIntSlice] = Field(
        default=None,
    ...
    quantity: Optional[V1alpha2NamedResourcesAttributeQuantity] = None
    string: Optional[StrictStr] = Field(
        default=None, description="StringValue is a string."
    )
    string_slice: Optional[V1alpha2NamedResourcesStringSlice] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "int": obj.get("int"),
                "intSlice": (
                    V1alpha2NamedResourcesIntSlice.from_dict(obj["intSlice"])
                    if obj.get("intSlice") is not None
                    else None
                ),
                "name": obj.get("name") if obj.get("name") is not None else "",
                "quantity": (
                    V1alpha2NamedResourcesAttributeQuantity.from_dict(obj["quantity"])
                    if obj.get("quantity") is not None
                    else None
                ),
                "string": obj.get("string"),
                "stringSlice": (
                    V1alpha2NamedResourcesStringSlice.from_dict(obj["stringSlice"])
                    if obj.get("stringSlice") is not None
                    else None
                ),
