...
from kubernetes_asyncio.models.v1alpha2_named_resources_attribute import (
...
class V1alpha2NamedResourcesInstance(BaseModel):
    ...
    attributes: Optional[List[V1alpha2NamedResourcesAttribute]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "attributes": (
                    [
                        V1alpha2NamedResourcesAttribute.from_dict(_item)
