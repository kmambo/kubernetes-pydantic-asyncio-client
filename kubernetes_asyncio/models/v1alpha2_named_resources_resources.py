...
from kubernetes_asyncio.models.v1alpha2_named_resources_instance import (
    V1alpha2NamedResourcesInstance,
)


class V1alpha2NamedResourcesResources(BaseModel):
    """
    NamedResourcesResources is used in ResourceModel.
    """  # noqa: E501

    instances: List[V1alpha2NamedResourcesInstance] = Field(
        ...
        _obj = cls.model_validate(
            {
                "instances": (
                    [
                        V1alpha2NamedResourcesInstance.from_dict(_item)
