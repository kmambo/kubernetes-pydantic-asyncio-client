...
class V1alpha2NamedResourcesStringSlice(BaseModel):
    """
    NamedResourcesStringSlice contains a slice of strings.
    """  # noqa: E501

    strings: List[StrictStr] = Field(description="Strings is the slice of strings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"strings": obj.get("strings")})
        return _obj
