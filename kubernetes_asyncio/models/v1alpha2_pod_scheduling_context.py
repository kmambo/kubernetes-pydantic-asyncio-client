...
from kubernetes_asyncio.models.v1alpha2_pod_scheduling_context_spec import (
    V1alpha2PodSchedulingContextSpec,
)
from kubernetes_asyncio.models.v1alpha2_pod_scheduling_context_status import (
    V1alpha2PodSchedulingContextStatus,
)


class V1alpha2PodSchedulingContext(BaseModel):
    """
    ...
    spec: V1alpha2PodSchedulingContextSpec = Field(
        description="Spec describes where resources for the Pod are needed."
    )
    status: Optional[V1alpha2PodSchedulingContextStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha2PodSchedulingContextSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1alpha2PodSchedulingContextStatus.from_dict(obj["status"])
