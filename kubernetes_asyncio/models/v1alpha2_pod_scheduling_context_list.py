...
from kubernetes_asyncio.models.v1alpha2_pod_scheduling_context import (
    V1alpha2PodSchedulingContext,
)


class V1alpha2PodSchedulingContextList(BaseModel):
    """
    ...
    items: List[V1alpha2PodSchedulingContext] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha2PodSchedulingContext.from_dict(_item)
