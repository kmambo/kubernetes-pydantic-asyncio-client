...
from kubernetes_asyncio.models.v1alpha2_resource_claim_scheduling_status import (
...
class V1alpha2PodSchedulingContextStatus(BaseModel):
    ...
    resource_claims: Optional[List[V1alpha2ResourceClaimSchedulingStatus]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "resourceClaims": (
                    [
                        V1alpha2ResourceClaimSchedulingStatus.from_dict(_item)
