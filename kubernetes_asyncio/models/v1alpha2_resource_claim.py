...
from kubernetes_asyncio.models.v1alpha2_resource_claim_spec import (
    V1alpha2ResourceClaimSpec,
)
from kubernetes_asyncio.models.v1alpha2_resource_claim_status import (
    V1alpha2ResourceClaimStatus,
)


class V1alpha2ResourceClaim(BaseModel):
    """
    ...
    spec: V1alpha2ResourceClaimSpec = Field(
    ...
    status: Optional[V1alpha2ResourceClaimStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha2ResourceClaimSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1alpha2ResourceClaimStatus.from_dict(obj["status"])
