...
from kubernetes_asyncio.models.v1alpha2_resource_claim_parameters import (
    V1alpha2ResourceClaimParameters,
)


class V1alpha2ResourceClaimParametersList(BaseModel):
    """
    ...
    items: List[V1alpha2ResourceClaimParameters] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha2ResourceClaimParameters.from_dict(_item)
