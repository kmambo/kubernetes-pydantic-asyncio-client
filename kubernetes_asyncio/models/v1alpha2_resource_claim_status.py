...
from kubernetes_asyncio.models.v1alpha2_allocation_result import (
    V1alpha2AllocationResult,
)
from kubernetes_asyncio.models.v1alpha2_resource_claim_consumer_reference import (
...
class V1alpha2ResourceClaimStatus(BaseModel):
    ...
    allocation: Optional[V1alpha2AllocationResult] = Field(
        default=None,
    ...
    deallocation_requested: Optional[StrictBool] = Field(
        default=None,
        description="DeallocationRequested indicates that a ResourceClaim is to be deallocated.  The driver then must deallocate this claim and reset the field together with clearing the Allocation field.  While DeallocationRequested is set, no new consumers may be added to ReservedFor.",
    ...
    reserved_for: Optional[List[V1alpha2ResourceClaimConsumerReference]] = Field(
        default=None,
        description="ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started.  There can be at most 32 such reservations. This may get increased in the future, but not reduced.",
        alias="reservedFor",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allocation": (
                    V1alpha2AllocationResult.from_dict(obj["allocation"])
                ...
                "reservedFor": (
                    [
                        V1alpha2ResourceClaimConsumerReference.from_dict(_item)
