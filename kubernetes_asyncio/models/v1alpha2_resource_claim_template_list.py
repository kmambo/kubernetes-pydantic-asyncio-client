...
from kubernetes_asyncio.models.v1alpha2_resource_claim_template import (
    V1alpha2ResourceClaimTemplate,
)


class V1alpha2ResourceClaimTemplateList(BaseModel):
    """
    ...
    items: List[V1alpha2ResourceClaimTemplate] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha2ResourceClaimTemplate.from_dict(_item)
