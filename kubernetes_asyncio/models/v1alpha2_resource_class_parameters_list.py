...
from kubernetes_asyncio.models.v1alpha2_resource_class_parameters import (
    V1alpha2ResourceClassParameters,
)


class V1alpha2ResourceClassParametersList(BaseModel):
    """
    ...
    items: List[V1alpha2ResourceClassParameters] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha2ResourceClassParameters.from_dict(_item)
