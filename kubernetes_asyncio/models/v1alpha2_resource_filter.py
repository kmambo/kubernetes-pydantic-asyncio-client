...
from kubernetes_asyncio.models.v1alpha2_named_resources_filter import (
    V1alpha2NamedResourcesFilter,
)


class V1alpha2ResourceFilter(BaseModel):
    """
    ...
    named_resources: Optional[V1alpha2NamedResourcesFilter] = Field(
        default=None,
        description="NamedResources describes a resource filter using the named resources model.",
        alias="namedResources",
    )
    __properties: ClassVar[List[str]] = ["driverName", "namedResources"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "namedResources": (
                    V1alpha2NamedResourcesFilter.from_dict(obj["namedResources"])
