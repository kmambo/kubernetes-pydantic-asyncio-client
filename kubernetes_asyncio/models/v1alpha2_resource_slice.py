...
from kubernetes_asyncio.models.v1alpha2_named_resources_resources import (
...
class V1alpha2ResourceSlice(BaseModel):
    ...
    named_resources: Optional[V1alpha2NamedResourcesResources] = Field(
        default=None,
    ...
    node_name: Optional[StrictStr] = Field(
        default=None,
        description="NodeName identifies the node which provides the resources if they are local to a node.  A field selector can be used to list only ResourceSlice objects with a certain node name.",
        alias="nodeName",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "namedResources": (
                    V1alpha2NamedResourcesResources.from_dict(obj["namedResources"])
                    if obj.get("namedResources") is not None
                    else None
                ),
