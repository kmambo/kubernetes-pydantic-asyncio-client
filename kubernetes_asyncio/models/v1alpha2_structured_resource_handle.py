...
from kubernetes_asyncio.models.v1alpha2_driver_allocation_result import (
...
class V1alpha2StructuredResourceHandle(BaseModel):
    ...
    results: List[V1alpha2DriverAllocationResult] = Field(
        description="Results lists all allocated driver resources."
    )
    vendor_claim_parameters: Optional[Dict[str, Any]] = Field(
        default=None,
    ...
    vendor_class_parameters: Optional[Dict[str, Any]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [
                        V1alpha2DriverAllocationResult.from_dict(_item)
