...
class V1alpha2VendorParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["driverName", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"driverName": obj.get("driverName"), "parameters": obj.get("parameters")}
        )
        return _obj
