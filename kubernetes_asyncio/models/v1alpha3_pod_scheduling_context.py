...
from kubernetes_asyncio.models.v1alpha3_pod_scheduling_context_spec import (
    V1alpha3PodSchedulingContextSpec,
)
from kubernetes_asyncio.models.v1alpha3_pod_scheduling_context_status import (
    V1alpha3PodSchedulingContextStatus,
)


class V1alpha3PodSchedulingContext(BaseModel):
    """
    ...
    spec: V1alpha3PodSchedulingContextSpec = Field(
        description="Spec describes where resources for the Pod are needed."
    )
    status: Optional[V1alpha3PodSchedulingContextStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1alpha3PodSchedulingContextSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1alpha3PodSchedulingContextStatus.from_dict(obj["status"])
