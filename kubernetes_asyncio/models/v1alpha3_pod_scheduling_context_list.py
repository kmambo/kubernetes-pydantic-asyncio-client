...
from kubernetes_asyncio.models.v1alpha3_pod_scheduling_context import (
    V1alpha3PodSchedulingContext,
)


class V1alpha3PodSchedulingContextList(BaseModel):
    """
    ...
    items: List[V1alpha3PodSchedulingContext] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1alpha3PodSchedulingContext.from_dict(_item)
