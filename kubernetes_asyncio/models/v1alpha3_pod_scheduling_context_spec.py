...
class V1alpha3PodSchedulingContextSpec(BaseModel):
    """
    PodSchedulingContextSpec describes where resources for the Pod are needed.
    """  # noqa: E501

    potential_nodes: Optional[List[StrictStr]] = Field(
        default=None,
        description="PotentialNodes lists nodes where the Pod might be able to run.  The size of this field is limited to 128. This is large enough for many clusters. Larger clusters may need more attempts to find a node that suits all pending resources. This may get increased in the future, but not reduced.",
        alias="potentialNodes",
    )
    selected_node: Optional[StrictStr] = Field(
        default=None,
