...
from kubernetes_asyncio.models.v1alpha3_resource_claim_scheduling_status import (
    V1alpha3ResourceClaimSchedulingStatus,
)


class V1alpha3PodSchedulingContextStatus(BaseModel):
    """
    PodSchedulingContextStatus describes where resources for the Pod can be allocated.
    """  # noqa: E501

    resource_claims: Optional[List[V1alpha3ResourceClaimSchedulingStatus]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "resourceClaims": (
                    [
                        V1alpha3ResourceClaimSchedulingStatus.from_dict(_item)
