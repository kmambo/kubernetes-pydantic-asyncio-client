...
class V1beta1BasicDevice(BaseModel):
    ...
    taints: Optional[List[V1beta1DeviceTaint]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "consumesCounters": (
                    [
                        V1beta1DeviceCounterConsumption.from_dict(_item)
                ...
                "taints": (
                    [V1beta1DeviceTaint.from_dict(_item) for _item in obj["taints"]]
