...
class V1beta1DeviceRequest(BaseModel):
    ...
    first_available: Optional[List[V1beta1DeviceSubRequest]] = Field(
        default=None,
    ...
    name: StrictStr = Field(
        description="Name can be used to reference this request in a pod.spec.containers[].resources.claims entry and in a constraint of the claim.  Must be a DNS label and unique among all DeviceRequests in a ResourceClaim."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "firstAvailable": (
                    [
                        V1beta1DeviceSubRequest.from_dict(_item)
