...
class V1beta1ValidatingAdmissionPolicySpec(BaseModel):
    ...
    audit_annotations: Optional[List[V1beta1AuditAnnotation]] = Field(
        default=None,
    ...
    validations: Optional[List[V1beta1Validation]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "auditAnnotations": (
                    [
                        V1beta1AuditAnnotation.from_dict(_item)
                ...
                "validations": (
                    [V1beta1Validation.from_dict(_item) for _item in obj["validations"]]
