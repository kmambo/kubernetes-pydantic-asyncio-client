...
class V1beta3FlowSchema(BaseModel):
    """
    ...
    spec: Optional[V1beta3FlowSchemaSpec] = Field(
        default=None,
    ...
    status: Optional[V1beta3FlowSchemaStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1beta3FlowSchemaSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1beta3FlowSchemaStatus.from_dict(obj["status"])
