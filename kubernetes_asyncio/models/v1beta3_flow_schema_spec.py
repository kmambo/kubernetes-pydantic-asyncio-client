...
from kubernetes_asyncio.models.v1beta3_flow_distinguisher_method import (
    V1beta3FlowDistinguisherMethod,
)
from kubernetes_asyncio.models.v1beta3_policy_rules_with_subjects import (
    V1beta3PolicyRulesWithSubjects,
)
from kubernetes_asyncio.models.v1beta3_priority_level_configuration_reference import (
...
class V1beta3FlowSchemaSpec(BaseModel):
    ...
    distinguisher_method: Optional[V1beta3FlowDistinguisherMethod] = Field(
        default=None,
    ...
    priority_level_configuration: V1beta3PriorityLevelConfigurationReference = Field(
    ...
    rules: Optional[List[V1beta3PolicyRulesWithSubjects]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.priority_level_configuration:
            _dict["priorityLevelConfiguration"] = (
                self.priority_level_configuration.to_dict()
            )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "distinguisherMethod": (
                    V1beta3FlowDistinguisherMethod.from_dict(obj["distinguisherMethod"])
                    if obj.get("distinguisherMethod") is not None
                    else None
                ),
                "matchingPrecedence": (
                    obj.get("matchingPrecedence")
                    if obj.get("matchingPrecedence") is not None
                    else 0
                ),
                "priorityLevelConfiguration": (
                    V1beta3PriorityLevelConfigurationReference.from_dict(
                        obj["priorityLevelConfiguration"]
                    )
                    if obj.get("priorityLevelConfiguration") is not None
                    else None
                ),
                "rules": (
                    [
                        V1beta3PolicyRulesWithSubjects.from_dict(_item)
