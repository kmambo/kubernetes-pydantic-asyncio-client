...
from kubernetes_asyncio.models.v1beta3_flow_schema_condition import (
...
class V1beta3FlowSchemaStatus(BaseModel):
    ...
    conditions: Optional[List[V1beta3FlowSchemaCondition]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "conditions": (
                    [
                        V1beta3FlowSchemaCondition.from_dict(_item)
