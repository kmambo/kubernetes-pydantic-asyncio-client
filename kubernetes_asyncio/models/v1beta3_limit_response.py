...
from kubernetes_asyncio.models.v1beta3_queuing_configuration import (
...
class V1beta3LimitResponse(BaseModel):
    ...
    queuing: Optional[V1beta3QueuingConfiguration] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "queuing": (
                    V1beta3QueuingConfiguration.from_dict(obj["queuing"])
