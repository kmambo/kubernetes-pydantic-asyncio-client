...
class V1beta3LimitedPriorityLevelConfiguration(BaseModel):
    ...
    limit_response: Optional[V1beta3LimitResponse] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "limitResponse": (
                    V1beta3LimitResponse.from_dict(obj["limitResponse"])
                    if obj.get("limitResponse") is not None
                    else None
                ),
                "nominalConcurrencyShares": (
                    obj.get("nominalConcurrencyShares")
                    if obj.get("nominalConcurrencyShares") is not None
                    else 0
                ),
            }
        )
