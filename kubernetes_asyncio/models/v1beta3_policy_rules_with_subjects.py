...
from kubernetes_asyncio.models.v1beta3_non_resource_policy_rule import (
    V1beta3NonResourcePolicyRule,
)
from kubernetes_asyncio.models.v1beta3_resource_policy_rule import (
...
class V1beta3PolicyRulesWithSubjects(BaseModel):
    ...
    non_resource_rules: Optional[List[V1beta3NonResourcePolicyRule]] = Field(
        default=None,
    ...
    resource_rules: Optional[List[V1beta3ResourcePolicyRule]] = Field(
        default=None,
    ...
    subjects: List[V1beta3Subject] = Field(
        ...
        _obj = cls.model_validate(
            {
                "nonResourceRules": (
                    [
                        V1beta3NonResourcePolicyRule.from_dict(_item)
                        for _item in obj["nonResourceRules"]
                    ]
                    if obj.get("nonResourceRules") is not None
                    else None
                ),
                "resourceRules": (
                    [
                        V1beta3ResourcePolicyRule.from_dict(_item)
                ...
                "subjects": (
                    [V1beta3Subject.from_dict(_item) for _item in obj["subjects"]]
