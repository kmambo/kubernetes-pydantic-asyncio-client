...
from kubernetes_asyncio.models.v1beta3_priority_level_configuration_spec import (
    V1beta3PriorityLevelConfigurationSpec,
)
from kubernetes_asyncio.models.v1beta3_priority_level_configuration_status import (
    V1beta3PriorityLevelConfigurationStatus,
)


class V1beta3PriorityLevelConfiguration(BaseModel):
    """
    ...
    spec: Optional[V1beta3PriorityLevelConfigurationSpec] = Field(
        default=None,
    ...
    status: Optional[V1beta3PriorityLevelConfigurationStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1beta3PriorityLevelConfigurationSpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1beta3PriorityLevelConfigurationStatus.from_dict(obj["status"])
