...
class V1beta3PriorityLevelConfigurationList(BaseModel):
    """
    ...
    items: List[V1beta3PriorityLevelConfiguration] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "items": (
                    [
                        V1beta3PriorityLevelConfiguration.from_dict(_item)
