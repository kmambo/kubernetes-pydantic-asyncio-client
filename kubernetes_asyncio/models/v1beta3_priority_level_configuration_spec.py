...
from kubernetes_asyncio.models.v1beta3_exempt_priority_level_configuration import (
    V1beta3ExemptPriorityLevelConfiguration,
)
from kubernetes_asyncio.models.v1beta3_limited_priority_level_configuration import (
...
class V1beta3PriorityLevelConfigurationSpec(BaseModel):
    ...
    exempt: Optional[V1beta3ExemptPriorityLevelConfiguration] = Field(
        default=None,
    ...
    limited: Optional[V1beta3LimitedPriorityLevelConfiguration] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "exempt": (
                    V1beta3ExemptPriorityLevelConfiguration.from_dict(obj["exempt"])
                    if obj.get("exempt") is not None
                    else None
                ),
                "limited": (
                    V1beta3LimitedPriorityLevelConfiguration.from_dict(obj["limited"])
