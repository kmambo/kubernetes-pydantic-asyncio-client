...
from kubernetes_asyncio.models.v1beta3_priority_level_configuration_condition import (
    V1beta3PriorityLevelConfigurationCondition,
)


class V1beta3PriorityLevelConfigurationStatus(BaseModel):
    """
    PriorityLevelConfigurationStatus represents the current state of a \"request-priority\".
    """  # noqa: E501

    conditions: Optional[List[V1beta3PriorityLevelConfigurationCondition]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "conditions": (
                    [
                        V1beta3PriorityLevelConfigurationCondition.from_dict(_item)
