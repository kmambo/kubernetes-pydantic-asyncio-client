...
class V1beta3QueuingConfiguration(BaseModel):
    ...
    hand_size: Optional[StrictInt] = Field(
        default=0,
    ...
    queue_length_limit: Optional[StrictInt] = Field(
        default=0,
    ...
    queues: Optional[StrictInt] = Field(
        default=0,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "handSize": (
                    obj.get("handSize") if obj.get("handSize") is not None else 0
                ),
                "queueLengthLimit": (
                    obj.get("queueLengthLimit")
                    if obj.get("queueLengthLimit") is not None
                    else 0
                ),
                "queues": obj.get("queues") if obj.get("queues") is not None else 0,
            }
        )
        return _obj
