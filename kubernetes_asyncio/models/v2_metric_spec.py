...
class V2MetricSpec(BaseModel):
    ...
    container_resource: Optional[V2ContainerResourceMetricSource] = Field(
        default=None,
    ...
    external: Optional[V2ExternalMetricSource] = Field(
        default=None,
        description="external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).",
    )
    object: Optional[V2ObjectMetricSource] = Field(
        default=None,
        description="object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).",
    )
    pods: Optional[V2PodsMetricSource] = Field(
        default=None,
        description="pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.",
    )
    resource: Optional[V2ResourceMetricSource] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "containerResource": (
                    V2ContainerResourceMetricSource.from_dict(obj["containerResource"])
                    if obj.get("containerResource") is not None
                    else None
                ),
                "external": (
                    V2ExternalMetricSource.from_dict(obj["external"])
                    if obj.get("external") is not None
                    else None
                ),
                "object": (
                    V2ObjectMetricSource.from_dict(obj["object"])
                    if obj.get("object") is not None
                    else None
                ),
                "pods": (
                    V2PodsMetricSource.from_dict(obj["pods"])
                    if obj.get("pods") is not None
                    else None
                ),
                "resource": (
                    V2ResourceMetricSource.from_dict(obj["resource"])
