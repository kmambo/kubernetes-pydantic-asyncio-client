...
class AuthenticationV1beta1Api:
    ...
    async def create_self_subject_review(
        self,
        v1beta1_self_subject_review: V1beta1SelfSubjectReview,
        dry_run: Annotated[
        ...
        :param v1beta1_self_subject_review: (required)
        :type v1beta1_self_subject_review: V1beta1SelfSubjectReview
        ...
        _param = self._create_self_subject_review_serialize(
            v1beta1_self_subject_review=v1beta1_self_subject_review,
            dry_run=dry_run,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "V1beta1SelfSubjectReview",
            "201": "V1beta1SelfSubjectReview",
            "202": "V1beta1SelfSubjectReview",
            "401": None,
        }
    ...
    @validate_call
    async def create_self_subject_review_with_http_info(
        self,
        v1beta1_self_subject_review: V1beta1SelfSubjectReview,
        dry_run: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1beta1SelfSubjectReview]:
        """create_self_subject_review
    ...
    @validate_call
    async def create_self_subject_review_without_preload_content(
        self,
        v1beta1_self_subject_review: V1beta1SelfSubjectReview,
        dry_run: Annotated[
            Optional[Annotated[str, Field(strict=True)]],
    ...
    def _create_self_subject_review_serialize(
        ...
        if v1beta1_self_subject_review is not None:
            _body_params = v1beta1_self_subject_review
