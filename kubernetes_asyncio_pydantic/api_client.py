...
import kubernetes_asyncio_pydantic.models
from kubernetes_asyncio_pydantic import rest
from kubernetes_asyncio_pydantic.api_response import ApiResponse
from kubernetes_asyncio_pydantic.api_response import T as ApiResponseT
from kubernetes_asyncio_pydantic.configuration import Configuration
from kubernetes_asyncio_pydantic.exceptions import ApiException, ApiValueError
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/1.34.0/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kubernetes_asyncio_pydantic.models, klass)
