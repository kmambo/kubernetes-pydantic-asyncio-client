...
class V1ContainerStatus(BaseModel):
    ...
    allocated_resources: Optional[Dict[str, V1PodSpecOverheadValue]] = Field(
        default=None,
    ...
    last_state: Optional[V1ContainerState] = Field(
        default=None,
    ...
    started: Optional[StrictBool] = Field(
        default=None,
    ...
    state: Optional[V1ContainerState] = Field(
        default=None,
        ...
        if self.allocated_resources:
            for _key_allocated_resources in self.allocated_resources:
                if self.allocated_resources[_key_allocated_resources]:
                    _field_dict[_key_allocated_resources] = self.allocated_resources[
        ...
        _obj = cls.model_validate(
            {
                ...
                "lastState": (
                    V1ContainerState.from_dict(obj["lastState"])
                    if obj.get("lastState") is not None
                    else None
                ),
                ...
                "restartCount": (
                    obj.get("restartCount")
                    if obj.get("restartCount") is not None
                    else 0
                ),
                ...
                "volumeMounts": (
                    [
                        V1VolumeMountStatus.from_dict(_item)
