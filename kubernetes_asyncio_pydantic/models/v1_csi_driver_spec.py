...
class V1CSIDriverSpec(BaseModel):
    ...
    requires_republish: Optional[StrictBool] = Field(
        default=None,
    ...
    se_linux_mount: Optional[StrictBool] = Field(
        default=None,
    ...
    storage_capacity: Optional[StrictBool] = Field(
        default=None,
    ...
    token_requests: Optional[List[V1TokenRequest]] = Field(
        default=None,
    ...
    volume_lifecycle_modes: Optional[List[StrictStr]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "tokenRequests": (
                    [V1TokenRequest.from_dict(_item) for _item in obj["tokenRequests"]]
                    if obj.get("tokenRequests") is not None
                    else None
                ),
