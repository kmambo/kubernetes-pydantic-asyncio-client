...
class V1EnvVarSource(BaseModel):
    ...
    config_map_key_ref: Optional[V1ConfigMapKeySelector] = Field(
        default=None,
        description="Selects a key of a ConfigMap.",
        alias="configMapKeyRef",
    )
    field_ref: Optional[V1ObjectFieldSelector] = Field(
        default=None,
    ...
    secret_key_ref: Optional[V1SecretKeySelector] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "configMapKeyRef": (
                    V1ConfigMapKeySelector.from_dict(obj["configMapKeyRef"])
                ...
                "resourceFieldRef": (
                    V1ResourceFieldSelector.from_dict(obj["resourceFieldRef"])
                    if obj.get("resourceFieldRef") is not None
                    else None
                ),
                "secretKeyRef": (
                    V1SecretKeySelector.from_dict(obj["secretKeyRef"])
