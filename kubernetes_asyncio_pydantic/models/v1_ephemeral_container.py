...
class V1EphemeralContainer(BaseModel):
    ...
    args: Optional[List[StrictStr]] = Field(
        default=None,
    ...
    liveness_probe: Optional[V1Probe] = Field(
        default=None,
    ...
    readiness_probe: Optional[V1Probe] = Field(
        default=None,
        description="Probes are not allowed for ephemeral containers.",
        alias="readinessProbe",
    )
    resize_policy: Optional[List[V1ContainerResizePolicy]] = Field(
        default=None,
    ...
    startup_probe: Optional[V1Probe] = Field(
        default=None,
        description="Probes are not allowed for ephemeral containers.",
        alias="startupProbe",
    )
    ...
    volume_devices: Optional[List[V1VolumeDevice]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "env": (
                    [V1EnvVar.from_dict(_item) for _item in obj["env"]]
                ...
                "lifecycle": (
                    V1Lifecycle.from_dict(obj["lifecycle"])
                    if obj.get("lifecycle") is not None
                    else None
                ),
                "livenessProbe": (
                    V1Probe.from_dict(obj["livenessProbe"])
                    if obj.get("livenessProbe") is not None
                    else None
                ),
                "name": obj.get("name") if obj.get("name") is not None else "",
                "ports": (
                    [V1ContainerPort.from_dict(_item) for _item in obj["ports"]]
                    if obj.get("ports") is not None
                    else None
                ),
                "readinessProbe": (
                    V1Probe.from_dict(obj["readinessProbe"])
                    if obj.get("readinessProbe") is not None
                    else None
                ),
                "resizePolicy": (
                    [
                        V1ContainerResizePolicy.from_dict(_item)
                ...
                "startupProbe": (
                    V1Probe.from_dict(obj["startupProbe"])
                ...
                "tty": obj.get("tty"),
                "volumeDevices": (
                    [V1VolumeDevice.from_dict(_item) for _item in obj["volumeDevices"]]
