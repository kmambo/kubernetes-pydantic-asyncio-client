...
class V1Lifecycle(BaseModel):
    ...
    post_start: Optional[V1LifecycleHandler] = Field(
        default=None,
        description="PostStart is called immediately after a container is created. If the handler fails, the container is terminated and restarted according to its restart policy. Other management of the container blocks until the hook completes. More info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks",
        alias="postStart",
    )
    pre_stop: Optional[V1LifecycleHandler] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "postStart": (
                    V1LifecycleHandler.from_dict(obj["postStart"])
                    if obj.get("postStart") is not None
                    else None
                ),
                "preStop": (
                    V1LifecycleHandler.from_dict(obj["preStop"])
