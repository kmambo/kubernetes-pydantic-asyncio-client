...
class V1PodSpec(BaseModel):
    ...
    automount_service_account_token: Optional[StrictBool] = Field(
        default=None,
    ...
    dns_config: Optional[V1PodDNSConfig] = Field(
        default=None,
    ...
    host_users: Optional[StrictBool] = Field(
        default=None,
    ...
    preemption_policy: Optional[StrictStr] = Field(
        default=None,
    ...
    readiness_gates: Optional[List[V1PodReadinessGate]] = Field(
        default=None,
        description='If specified, all readiness gates will be evaluated for pod readiness. A pod is ready when all its containers are ready AND all conditions specified in the readiness gates have status equal to "True" More info: https://git.k8s.io/enhancements/keps/sig-network/580-pod-readiness-gates',
        alias="readinessGates",
    )
    resource_claims: Optional[List[V1PodResourceClaim]] = Field(
        default=None,
    ...
    runtime_class_name: Optional[StrictStr] = Field(
        default=None,
    ...
    scheduling_gates: Optional[List[V1PodSchedulingGate]] = Field(
        default=None,
    ...
    security_context: Optional[V1PodSecurityContext] = Field(
        default=None,
        description="SecurityContext holds pod-level security attributes and common container settings. Optional: Defaults to empty.  See type description for default values of each field.",
        alias="securityContext",
    )
    service_account: Optional[StrictStr] = Field(
        default=None,
    ...
    topology_spread_constraints: Optional[List[V1TopologySpreadConstraint]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "affinity": (
                    V1Affinity.from_dict(obj["affinity"])
                ...
                "dnsConfig": (
                    V1PodDNSConfig.from_dict(obj["dnsConfig"])
                ...
                "ephemeralContainers": (
                    [
                        V1EphemeralContainer.from_dict(_item)
                ...
                "hostAliases": (
                    [V1HostAlias.from_dict(_item) for _item in obj["hostAliases"]]
                ...
                "initContainers": (
                    [V1Container.from_dict(_item) for _item in obj["initContainers"]]
                ...
                "os": (
                    V1PodOS.from_dict(obj["os"]) if obj.get("os") is not None else None
                ),
                "overhead": (
                    dict(
                ...
                "readinessGates": (
                    [
                        V1PodReadinessGate.from_dict(_item)
                ...
                "resourceClaims": (
                    [
                        V1PodResourceClaim.from_dict(_item)
                ...
                "schedulingGates": (
                    [
                        V1PodSchedulingGate.from_dict(_item)
                        for _item in obj["schedulingGates"]
                    ]
                    if obj.get("schedulingGates") is not None
                    else None
                ),
                "securityContext": (
                    V1PodSecurityContext.from_dict(obj["securityContext"])
                ...
                "topologySpreadConstraints": (
                    [
                        V1TopologySpreadConstraint.from_dict(_item)
                ...
                "volumes": (
                    [V1Volume.from_dict(_item) for _item in obj["volumes"]]
