...
class V1ServiceSpec(BaseModel):
    ...
    allocate_load_balancer_node_ports: Optional[StrictBool] = Field(
        default=None,
    ...
    cluster_ip: Optional[StrictStr] = Field(
        default=None,
    ...
    cluster_ips: Optional[List[StrictStr]] = Field(
        default=None,
    ...
    external_traffic_policy: Optional[StrictStr] = Field(
        default=None,
    ...
    health_check_node_port: Optional[StrictInt] = Field(
        default=None,
    ...
    ip_family_policy: Optional[StrictStr] = Field(
        default=None,
    ...
    load_balancer_class: Optional[StrictStr] = Field(
        default=None,
    ...
    session_affinity: Optional[StrictStr] = Field(
        default=None,
        description='Supports "ClientIP" and "None". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies',
        alias="sessionAffinity",
    )
    session_affinity_config: Optional[V1SessionAffinityConfig] = Field(
        default=None,
        description="sessionAffinityConfig contains the configurations of session affinity.",
        alias="sessionAffinityConfig",
    )
    traffic_distribution: Optional[StrictStr] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allocateLoadBalancerNodePorts": obj.get(
                    "allocateLoadBalancerNodePorts"
                ),
                ...
                "ports": (
                    [V1ServicePort.from_dict(_item) for _item in obj["ports"]]
                ...
                "sessionAffinityConfig": (
                    V1SessionAffinityConfig.from_dict(obj["sessionAffinityConfig"])
                    if obj.get("sessionAffinityConfig") is not None
                    else None
                ),
