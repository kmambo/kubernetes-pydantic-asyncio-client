...
class V1TopologySpreadConstraint(BaseModel):
    ...
    label_selector: Optional[V1LabelSelector] = Field(
        default=None,
        description="LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology domain.",
        alias="labelSelector",
    )
    match_label_keys: Optional[List[StrictStr]] = Field(
        default=None,
    ...
    node_affinity_policy: Optional[StrictStr] = Field(
        default=None,
    ...
    node_taints_policy: Optional[StrictStr] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "labelSelector": (
                    V1LabelSelector.from_dict(obj["labelSelector"])
                ...
                "topologyKey": (
                    obj.get("topologyKey") if obj.get("topologyKey") is not None else ""
                ),
                "whenUnsatisfiable": (
                    obj.get("whenUnsatisfiable")
                    if obj.get("whenUnsatisfiable") is not None
                    else ""
                ),
            }
        )
