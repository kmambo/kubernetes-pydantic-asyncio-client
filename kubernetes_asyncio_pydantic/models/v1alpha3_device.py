...
class V1alpha3Device(BaseModel):
    ...
    basic: Optional[V1alpha3BasicDevice] = Field(
        default=None, description="Basic defines one device instance."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "basic": (
                    V1alpha3BasicDevice.from_dict(obj["basic"])
                    if obj.get("basic") is not None
                    else None
                ),
