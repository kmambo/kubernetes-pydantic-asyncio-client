...
class V1alpha3DeviceAllocationResult(BaseModel):
    ...
    config: Optional[List[V1alpha3DeviceAllocationConfiguration]] = Field(
        default=None,
    ...
    results: Optional[List[V1alpha3DeviceRequestAllocationResult]] = Field(
        ...
        _obj = cls.model_validate(
            {
                "config": (
                    [
                        V1alpha3DeviceAllocationConfiguration.from_dict(_item)
                ...
                "results": (
                    [
                        V1alpha3DeviceRequestAllocationResult.from_dict(_item)
