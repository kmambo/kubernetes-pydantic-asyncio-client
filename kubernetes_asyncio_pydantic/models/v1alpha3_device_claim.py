...
class V1alpha3DeviceClaim(BaseModel):
    ...
    config: Optional[List[V1alpha3DeviceClaimConfiguration]] = Field(
        default=None,
    ...
    constraints: Optional[List[V1alpha3DeviceConstraint]] = Field(
        default=None,
        description="These constraints must be satisfied by the set of devices that get allocated for the claim.",
    )
    requests: Optional[List[V1alpha3DeviceRequest]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "config": (
                    [
                        V1alpha3DeviceClaimConfiguration.from_dict(_item)
                ...
                "constraints": (
                    [
                        V1alpha3DeviceConstraint.from_dict(_item)
                ...
                "requests": (
                    [
                        V1alpha3DeviceRequest.from_dict(_item)
