...
class V1beta1ValidatingAdmissionPolicy(BaseModel):
    ...
    spec: Optional[V1beta1ValidatingAdmissionPolicySpec] = Field(
        default=None,
        description="Specification of the desired behavior of the ValidatingAdmissionPolicy.",
    )
    status: Optional[V1beta1ValidatingAdmissionPolicyStatus] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": (
                    V1beta1ValidatingAdmissionPolicySpec.from_dict(obj["spec"])
                    if obj.get("spec") is not None
                    else None
                ),
                "status": (
                    V1beta1ValidatingAdmissionPolicyStatus.from_dict(obj["status"])
