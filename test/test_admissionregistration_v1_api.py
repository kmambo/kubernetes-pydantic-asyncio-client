...
from kubernetes_asyncio.api.admissionregistration_v1_api import AdmissionregistrationV1Api
...
class TestAdmissionregistrationV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_mutating_webhook_configuration(self) -> None:
    ...
    async def test_create_validating_webhook_configuration(self) -> None:
        """Test case for create_validating_webhook_configuration

        """
        pass

    async def test_delete_collection_mutating_webhook_configuration(self) -> None:
    ...
    async def test_delete_collection_validating_webhook_configuration(self) -> None:
        """Test case for delete_collection_validating_webhook_configuration

        """
        pass

    async def test_delete_mutating_webhook_configuration(self) -> None:
    ...
    async def test_delete_validating_webhook_configuration(self) -> None:
    ...
    async def test_list_mutating_webhook_configuration(self) -> None:
    ...
    async def test_list_validating_webhook_configuration(self) -> None:
        """Test case for list_validating_webhook_configuration

        """
        pass

    async def test_patch_mutating_webhook_configuration(self) -> None:
    ...
    async def test_patch_validating_webhook_configuration(self) -> None:
        """Test case for patch_validating_webhook_configuration

        """
        pass

    async def test_read_mutating_webhook_configuration(self) -> None:
    ...
    async def test_read_validating_webhook_configuration(self) -> None:
        """Test case for read_validating_webhook_configuration

        """
        pass

    async def test_replace_mutating_webhook_configuration(self) -> None:
    ...
    async def test_replace_validating_webhook_configuration(self) -> None:
