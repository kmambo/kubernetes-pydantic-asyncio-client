        ...
        if include_optional:
            return AuthenticationV1TokenRequest(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.client.models.v1/token_request_spec.v1.TokenRequestSpec(
                    audiences = [
                        ''
                        ], 
                ...
                status = kubernetes_asyncio.client.models.v1/token_request_status.v1.TokenRequestStatus(
