...
class TestCertificatesV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_certificate_signing_request(self) -> None:
        """Test case for create_certificate_signing_request

        """
        pass

    async def test_delete_certificate_signing_request(self) -> None:
        """Test case for delete_certificate_signing_request

        """
        pass

    async def test_delete_collection_certificate_signing_request(self) -> None:
    ...
    async def test_list_certificate_signing_request(self) -> None:
        """Test case for list_certificate_signing_request

        """
        pass

    async def test_patch_certificate_signing_request(self) -> None:
        """Test case for patch_certificate_signing_request

        """
        pass

    async def test_patch_certificate_signing_request_approval(self) -> None:
        """Test case for patch_certificate_signing_request_approval

        """
        pass

    async def test_patch_certificate_signing_request_status(self) -> None:
        """Test case for patch_certificate_signing_request_status

        """
        pass

    async def test_read_certificate_signing_request(self) -> None:
        """Test case for read_certificate_signing_request

        """
        pass

    async def test_read_certificate_signing_request_approval(self) -> None:
        """Test case for read_certificate_signing_request_approval

        """
        pass

    async def test_read_certificate_signing_request_status(self) -> None:
        """Test case for read_certificate_signing_request_status

        """
        pass

    async def test_replace_certificate_signing_request(self) -> None:
        """Test case for replace_certificate_signing_request

        """
        pass

    async def test_replace_certificate_signing_request_approval(self) -> None:
        """Test case for replace_certificate_signing_request_approval

        """
        pass

    async def test_replace_certificate_signing_request_status(self) -> None:
