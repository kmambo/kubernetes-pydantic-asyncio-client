...
class TestCoordinationV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self) -> None:
        self.api = CoordinationV1Api()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_create_namespaced_lease(self) -> None:
        """Test case for create_namespaced_lease

        """
        pass

    async def test_delete_collection_namespaced_lease(self) -> None:
        """Test case for delete_collection_namespaced_lease

        """
        pass

    async def test_delete_namespaced_lease(self) -> None:
    ...
    async def test_list_lease_for_all_namespaces(self) -> None:
        """Test case for list_lease_for_all_namespaces

        """
        pass

    async def test_list_namespaced_lease(self) -> None:
        """Test case for list_namespaced_lease

        """
        pass

    async def test_patch_namespaced_lease(self) -> None:
        """Test case for patch_namespaced_lease

        """
        pass

    async def test_read_namespaced_lease(self) -> None:
        """Test case for read_namespaced_lease

        """
        pass

    async def test_replace_namespaced_lease(self) -> None:
