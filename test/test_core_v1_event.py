...
class TestCoreV1Event(unittest.TestCase):
    """CoreV1Event unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1Event:
        """Test CoreV1Event
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1Event`
        """
        model = CoreV1Event()
        if include_optional:
            return CoreV1Event(
                ...
                involved_object = kubernetes_asyncio.client.models.v1/object_reference.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
                ...
                reporting_component = '',
                reporting_instance = '',
                series = kubernetes_asyncio.client.models.core/v1/event_series.core.v1.EventSeries(
                    count = 56, 
                    last_observed_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                source = kubernetes_asyncio.client.models.v1/event_source.v1.EventSource(
                    component = '', 
                    host = '', ),
                type = ''
            )
