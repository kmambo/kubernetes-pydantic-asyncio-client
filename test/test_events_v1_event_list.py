...
class TestEventsV1EventList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventsV1EventList:
        """Test EventsV1EventList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsV1EventList`
        """
        model = EventsV1EventList()
        if include_optional:
            return EventsV1EventList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.events/v1/event.events.v1.Event(
                        action = '', 
                        api_version = '', 
                        deprecated_count = 56, 
