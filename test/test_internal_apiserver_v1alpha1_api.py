...
class TestInternalApiserverV1alpha1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_storage_version(self) -> None:
        """Test case for create_storage_version

        """
        pass

    async def test_delete_collection_storage_version(self) -> None:
        """Test case for delete_collection_storage_version

        """
        pass

    async def test_delete_storage_version(self) -> None:
    ...
    async def test_list_storage_version(self) -> None:
        """Test case for list_storage_version

        """
        pass

    async def test_patch_storage_version(self) -> None:
        """Test case for patch_storage_version

        """
        pass

    async def test_patch_storage_version_status(self) -> None:
        """Test case for patch_storage_version_status

        """
        pass

    async def test_read_storage_version(self) -> None:
        """Test case for read_storage_version

        """
        pass

    async def test_read_storage_version_status(self) -> None:
        """Test case for read_storage_version_status

        """
        pass

    async def test_replace_storage_version(self) -> None:
        """Test case for replace_storage_version

        """
        pass

    async def test_replace_storage_version_status(self) -> None:
