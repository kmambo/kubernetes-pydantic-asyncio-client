...
class TestV1Binding(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1Binding:
        """Test V1Binding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1Binding`
        """
        model = V1Binding()
        if include_optional:
            return V1Binding(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                target = kubernetes_asyncio.client.models.v1/object_reference.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
