    ...
    def make_instance(self, include_optional) -> V1ClusterRoleList:
        ...
        if include_optional:
            return V1ClusterRoleList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/cluster_role.v1.ClusterRole(
                        aggregation_rule = kubernetes_asyncio.client.models.v1/aggregation_rule.v1.AggregationRule(
                            cluster_role_selectors = [
                                kubernetes_asyncio.client.models.v1/label_selector.v1.LabelSelector(
                                    match_expressions = [
                        ...
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            uid = '', ), 
                        rules = [
                            kubernetes_asyncio.client.models.v1/policy_rule.v1.PolicyRule(
                                api_groups = [
                                    ''
                                    ], 
                                non_resource_urls = [
