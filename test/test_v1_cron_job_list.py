    ...
    def make_instance(self, include_optional) -> V1CronJobList:
        ...
        if include_optional:
            return V1CronJobList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/cron_job.v1.CronJob(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1/cron_job_spec.v1.CronJobSpec(
                            concurrency_policy = '', 
                            ...
                            suspend = True, 
                            time_zone = '', ), 
                        status = kubernetes_asyncio.client.models.v1/cron_job_status.v1.CronJobStatus(
                            active = [
