...
class TestV1CrossVersionObjectReference(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1CrossVersionObjectReference:
        """Test V1CrossVersionObjectReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1CrossVersionObjectReference`
        """
        model = V1CrossVersionObjectReference()
        if include_optional:
