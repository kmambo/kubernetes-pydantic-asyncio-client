...
class TestV1CustomResourceDefinitionNames(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1CustomResourceDefinitionNames:
        """Test V1CustomResourceDefinitionNames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1CustomResourceDefinitionNames`
        """
        model = V1CustomResourceDefinitionNames()
        if include_optional:
