...
class TestV1CustomResourceDefinitionVersion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1CustomResourceDefinitionVersion:
        """Test V1CustomResourceDefinitionVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1CustomResourceDefinitionVersion`
        """
        model = V1CustomResourceDefinitionVersion()
        if include_optional:
            return V1CustomResourceDefinitionVersion(
                ...
                deprecation_warning = '',
                name = '',
                var_schema = kubernetes_asyncio.client.models.v1/custom_resource_validation.v1.CustomResourceValidation(
