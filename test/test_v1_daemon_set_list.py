...
class TestV1DaemonSetList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1DaemonSetList:
        """Test V1DaemonSetList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DaemonSetList`
        """
        model = V1DaemonSetList()
        if include_optional:
            return V1DaemonSetList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/daemon_set.v1.DaemonSet(
                        api_version = '', 
                        kind = '', 
