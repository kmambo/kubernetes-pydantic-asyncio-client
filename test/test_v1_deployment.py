        ...
        if include_optional:
            return V1Deployment(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.client.models.v1/deployment_spec.v1.DeploymentSpec(
                    ...
                    strategy = kubernetes_asyncio.client.models.v1/deployment_strategy.v1.DeploymentStrategy(
                        rolling_update = kubernetes_asyncio.client.models.v1/rolling_update_deployment.v1.RollingUpdateDeployment(
                ...
                status = kubernetes_asyncio.client.models.v1/deployment_status.v1.DeploymentStatus(
                    available_replicas = 56, 
                    collision_count = 56, 
                    conditions = [
                        kubernetes_asyncio.client.models.v1/deployment_condition.v1.DeploymentCondition(
