    ...
    def make_instance(self, include_optional) -> V1EnvVarSource:
        ...
        if include_optional:
            return V1EnvVarSource(
                config_map_key_ref = kubernetes_asyncio_pydantic.models.v1/config_map_key_selector.v1.ConfigMapKeySelector(
                    key = '', 
                    name = '', 
                    optional = True, ),
                ...
                resource_field_ref = kubernetes_asyncio_pydantic.models.v1/resource_field_selector.v1.ResourceFieldSelector(
                    ...
                    divisor = null, 
                    resource = '', ),
                secret_key_ref = kubernetes_asyncio_pydantic.models.v1/secret_key_selector.v1.SecretKeySelector(
                    key = '', 
                    name = '', 
                    optional = True, )
            )
