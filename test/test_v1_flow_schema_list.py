    ...
    def make_instance(self, include_optional) -> V1FlowSchemaList:
        ...
        if include_optional:
            return V1FlowSchemaList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/flow_schema.v1.FlowSchema(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1/flow_schema_spec.v1.FlowSchemaSpec(
                            distinguisher_method = kubernetes_asyncio.client.models.v1/flow_distinguisher_method.v1.FlowDistinguisherMethod(
                                type = '', ), 
                            matching_precedence = 56, 
                            priority_level_configuration = kubernetes_asyncio.client.models.v1/priority_level_configuration_reference.v1.PriorityLevelConfigurationReference(
                                name = '', ), 
                            rules = [
                                kubernetes_asyncio.client.models.v1/policy_rules_with_subjects.v1.PolicyRulesWithSubjects(
                                    non_resource_rules = [
                        ...
                        status = kubernetes_asyncio.client.models.v1/flow_schema_status.v1.FlowSchemaStatus(
                            conditions = [
