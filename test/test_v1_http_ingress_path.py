...
class TestV1HTTPIngressPath(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1HTTPIngressPath:
        """Test V1HTTPIngressPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1HTTPIngressPath`
        """
    ...
    def testV1HTTPIngressPath(self):
        """Test V1HTTPIngressPath"""
