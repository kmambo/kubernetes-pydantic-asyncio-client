    ...
    def make_instance(self, include_optional) -> V1NamespaceList:
        ...
        if include_optional:
            return V1NamespaceList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/namespace.v1.Namespace(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1/namespace_spec.v1.NamespaceSpec(), 
                        status = kubernetes_asyncio.client.models.v1/namespace_status.v1.NamespaceStatus(
                            conditions = [
                                kubernetes_asyncio.client.models.v1/namespace_condition.v1.NamespaceCondition(
