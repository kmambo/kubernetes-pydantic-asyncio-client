...
class TestV1NetworkPolicyList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1NetworkPolicyList:
        """Test V1NetworkPolicyList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1NetworkPolicyList`
        """
        model = V1NetworkPolicyList()
        if include_optional:
            return V1NetworkPolicyList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/network_policy.v1.NetworkPolicy(
                        api_version = '', 
                        kind = '', 
