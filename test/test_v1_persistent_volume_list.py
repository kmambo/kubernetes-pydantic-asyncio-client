...
class TestV1PersistentVolumeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1PersistentVolumeList:
        """Test V1PersistentVolumeList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1PersistentVolumeList`
        """
        model = V1PersistentVolumeList()
        if include_optional:
            return V1PersistentVolumeList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/persistent_volume.v1.PersistentVolume(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1/persistent_volume_spec.v1.PersistentVolumeSpec(
                            access_modes = [
                                ''
                                ], 
                            ...
                            vsphere_volume = kubernetes_asyncio.client.models.v1/vsphere_virtual_disk_volume_source.v1.VsphereVirtualDiskVolumeSource(
                                ...
                                storage_policy_name = '', 
                                volume_path = '', ), ), 
                        status = kubernetes_asyncio.client.models.v1/persistent_volume_status.v1.PersistentVolumeStatus(
