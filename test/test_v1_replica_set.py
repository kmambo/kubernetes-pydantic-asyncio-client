...
class TestV1ReplicaSet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1ReplicaSet:
        """Test V1ReplicaSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ReplicaSet`
        """
        model = V1ReplicaSet()
        if include_optional:
            return V1ReplicaSet(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.client.models.v1/replica_set_spec.v1.ReplicaSetSpec(
                ...
                status = kubernetes_asyncio.client.models.v1/replica_set_status.v1.ReplicaSetStatus(
                    available_replicas = 56, 
                    conditions = [
                        kubernetes_asyncio.client.models.v1/replica_set_condition.v1.ReplicaSetCondition(
