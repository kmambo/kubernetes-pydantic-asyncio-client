...
class TestV1ResourceClaimStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1ResourceClaimStatus:
        """Test V1ResourceClaimStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResourceClaimStatus`
        """
    ...
    def testV1ResourceClaimStatus(self):
        """Test V1ResourceClaimStatus"""
