    ...
    def make_instance(self, include_optional) -> V1ResourceQuotaList:
        ...
        if include_optional:
            return V1ResourceQuotaList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/resource_quota.v1.ResourceQuota(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1/resource_quota_spec.v1.ResourceQuotaSpec(
                            hard = {
                                'key' : ''
                                }, 
                        ...
                        status = kubernetes_asyncio.client.models.v1/resource_quota_status.v1.ResourceQuotaStatus(
                            used = {
                                'key' : ''
                                }, ), )
                    ],
