...
class TestV1ResourceSliceList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1ResourceSliceList:
        """Test V1ResourceSliceList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResourceSliceList`
        """
        model = V1ResourceSliceList()
        if include_optional:
    ...
    def testV1ResourceSliceList(self):
        """Test V1ResourceSliceList"""
