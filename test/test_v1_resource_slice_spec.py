...
class TestV1ResourceSliceSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1ResourceSliceSpec:
        """Test V1ResourceSliceSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResourceSliceSpec`
        """
        model = V1ResourceSliceSpec()
        if include_optional:
    ...
    def testV1ResourceSliceSpec(self):
        """Test V1ResourceSliceSpec"""
