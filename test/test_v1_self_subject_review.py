...
class TestV1SelfSubjectReview(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1SelfSubjectReview:
        """Test V1SelfSubjectReview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SelfSubjectReview`
        """
        model = V1SelfSubjectReview()
        if include_optional:
            return V1SelfSubjectReview(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                status = kubernetes_asyncio.client.models.v1/self_subject_review_status.v1.SelfSubjectReviewStatus(
    ...
    def testV1SelfSubjectReview(self):
        """Test V1SelfSubjectReview"""
