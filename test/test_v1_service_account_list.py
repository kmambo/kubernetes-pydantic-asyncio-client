...
class TestV1ServiceAccountList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1ServiceAccountList:
        """Test V1ServiceAccountList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ServiceAccountList`
        """
        model = V1ServiceAccountList()
        if include_optional:
            return V1ServiceAccountList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/service_account.v1.ServiceAccount(
                        api_version = '', 
                        ...
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            uid = '', ), 
                        secrets = [
                            kubernetes_asyncio.client.models.v1/object_reference.v1.ObjectReference(
                                api_version = '', 
                                field_path = '', 
                                kind = '', 
                                name = '', 
