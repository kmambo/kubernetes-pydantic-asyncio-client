...
class TestV1ServiceCIDRList(unittest.TestCase):
    """V1ServiceCIDRList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ServiceCIDRList:
        """Test V1ServiceCIDRList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ServiceCIDRList`
        """
        model = V1ServiceCIDRList()
        if include_optional:
            return V1ServiceCIDRList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1/service_cidr.v1.ServiceCIDR(
                        api_version = '', 
                        kind = '', 
    ...
    def testV1ServiceCIDRList(self):
        """Test V1ServiceCIDRList"""
