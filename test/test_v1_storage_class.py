    ...
    def make_instance(self, include_optional) -> V1StorageClass:
        ...
        if include_optional:
            return V1StorageClass(
                ...
                allowed_topologies = [
                    kubernetes_asyncio.client.models.v1/topology_selector_term.v1.TopologySelectorTerm(
                        match_label_expressions = [
                            kubernetes_asyncio.client.models.v1/topology_selector_label_requirement.v1.TopologySelectorLabelRequirement(
                                key = '', 
                                values = [
                                    ''
                                    ], )
