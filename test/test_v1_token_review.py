...
class TestV1TokenReview(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1TokenReview:
        """Test V1TokenReview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1TokenReview`
        """
        model = V1TokenReview()
        if include_optional:
            return V1TokenReview(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.client.models.v1/token_review_spec.v1.TokenReviewSpec(
                    audiences = [
                        ''
                        ], 
                    token = '', ),
                status = kubernetes_asyncio.client.models.v1/token_review_status.v1.TokenReviewStatus(
                    audiences = [
                        ''
                        ], 
                    authenticated = True, 
                    error = '', 
                    user = kubernetes_asyncio.client.models.v1/user_info.v1.UserInfo(
                        extra = {
                            'key' : [
                                ''
                                ]
