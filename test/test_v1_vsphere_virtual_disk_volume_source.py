...
class TestV1VsphereVirtualDiskVolumeSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1VsphereVirtualDiskVolumeSource:
        """Test V1VsphereVirtualDiskVolumeSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1VsphereVirtualDiskVolumeSource`
        """
        model = V1VsphereVirtualDiskVolumeSource()
        if include_optional:
