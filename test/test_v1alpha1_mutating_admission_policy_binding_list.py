    ...
    def make_instance(self, include_optional) -> V1alpha1MutatingAdmissionPolicyBindingList:
        ...
        if include_optional:
            return V1alpha1MutatingAdmissionPolicyBindingList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1alpha1/mutating_admission_policy_binding.v1alpha1.MutatingAdmissionPolicyBinding(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1alpha1/mutating_admission_policy_binding_spec.v1alpha1.MutatingAdmissionPolicyBindingSpec(
