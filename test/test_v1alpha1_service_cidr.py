        ...
        if include_optional:
            return V1alpha1ServiceCIDR(
                ...
                metadata = kubernetes_asyncio.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.models.v1alpha1/service_cidr_spec.v1alpha1.ServiceCIDRSpec(
                    cidrs = [
                        ''
                        ], ),
                status = kubernetes_asyncio.models.v1alpha1/service_cidr_status.v1alpha1.ServiceCIDRStatus(
                    conditions = [
                        null
                        ], )
            )
