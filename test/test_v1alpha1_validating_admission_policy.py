        ...
        if include_optional:
            return V1alpha1ValidatingAdmissionPolicy(
                ...
                metadata = kubernetes_asyncio.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio.models.v1alpha1/validating_admission_policy_spec.v1alpha1.ValidatingAdmissionPolicySpec(
                    audit_annotations = [
                        null
                        ], 
                    failure_policy = '', 
                ...
                status = kubernetes_asyncio.models.v1alpha1/validating_admission_policy_status.v1alpha1.ValidatingAdmissionPolicyStatus(
                    conditions = [
                        null
                        ], 
