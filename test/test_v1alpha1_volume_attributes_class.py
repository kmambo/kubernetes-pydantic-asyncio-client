...
class TestV1alpha1VolumeAttributesClass(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1alpha1VolumeAttributesClass:
        """Test V1alpha1VolumeAttributesClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha1VolumeAttributesClass`
        """
        model = V1alpha1VolumeAttributesClass()
        if include_optional:
    ...
    def testV1alpha1VolumeAttributesClass(self):
        """Test V1alpha1VolumeAttributesClass"""
