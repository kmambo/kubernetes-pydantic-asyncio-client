    ...
    def make_instance(self, include_optional) -> V1alpha2DriverAllocationResult:
        ...
        if include_optional:
            return V1alpha2DriverAllocationResult(
                named_resources = kubernetes_asyncio.models.v1alpha2/named_resources_allocation_result.v1alpha2.NamedResourcesAllocationResult(
                    name = '', ),
                vendor_request_parameters = None
            )
        else:
            return V1alpha2DriverAllocationResult(
        )
