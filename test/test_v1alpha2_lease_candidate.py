...
class TestV1alpha2LeaseCandidate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1alpha2LeaseCandidate:
        """Test V1alpha2LeaseCandidate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha2LeaseCandidate`
        """
        model = V1alpha2LeaseCandidate()
        if include_optional:
    ...
    def testV1alpha2LeaseCandidate(self):
        """Test V1alpha2LeaseCandidate"""
