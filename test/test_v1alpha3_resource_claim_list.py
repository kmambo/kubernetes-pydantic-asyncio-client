...
class TestV1alpha3ResourceClaimList(unittest.TestCase):
    """V1alpha3ResourceClaimList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alpha3ResourceClaimList:
        """Test V1alpha3ResourceClaimList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha3ResourceClaimList`
        """
        model = V1alpha3ResourceClaimList()
        if include_optional:
            return V1alpha3ResourceClaimList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1alpha3/resource_claim.v1alpha3.ResourceClaim(
                        api_version = '', 
                        kind = '', 
    ...
    def testV1alpha3ResourceClaimList(self):
        """Test V1alpha3ResourceClaimList"""
