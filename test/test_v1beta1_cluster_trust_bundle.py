...
class TestV1beta1ClusterTrustBundle(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ClusterTrustBundle:
        """Test V1beta1ClusterTrustBundle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta1ClusterTrustBundle`
        """
        model = V1beta1ClusterTrustBundle()
        if include_optional:
    ...
    def testV1beta1ClusterTrustBundle(self):
        """Test V1beta1ClusterTrustBundle"""
