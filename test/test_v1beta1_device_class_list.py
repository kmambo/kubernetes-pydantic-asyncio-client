...
class TestV1beta1DeviceClassList(unittest.TestCase):
    """V1beta1DeviceClassList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1DeviceClassList:
        """Test V1beta1DeviceClassList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta1DeviceClassList`
        """
        model = V1beta1DeviceClassList()
        if include_optional:
            return V1beta1DeviceClassList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta1/device_class.v1beta1.DeviceClass(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/device_class_spec.v1beta1.DeviceClassSpec(
                            config = [
    ...
    def testV1beta1DeviceClassList(self):
        """Test V1beta1DeviceClassList"""
