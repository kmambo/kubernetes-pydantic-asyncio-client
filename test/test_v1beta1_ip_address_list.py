    ...
    def make_instance(self, include_optional) -> V1beta1IPAddressList:
        ...
        if include_optional:
            return V1beta1IPAddressList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta1/ip_address.v1beta1.IPAddress(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/ip_address_spec.v1beta1.IPAddressSpec(
