        ...
        if include_optional:
            return V1beta1ValidatingAdmissionPolicy(
                ...
                metadata = kubernetes_asyncio_pydantic.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes_asyncio_pydantic.models.v1beta1/validating_admission_policy_spec.v1beta1.ValidatingAdmissionPolicySpec(
                    audit_annotations = [
                        null
                        ], 
                    failure_policy = '', 
                ...
                status = kubernetes_asyncio_pydantic.models.v1beta1/validating_admission_policy_status.v1beta1.ValidatingAdmissionPolicyStatus(
                    conditions = [
                        null
                        ], 
