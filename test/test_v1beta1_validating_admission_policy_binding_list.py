    ...
    def make_instance(self, include_optional) -> V1beta1ValidatingAdmissionPolicyBindingList:
        ...
        if include_optional:
            return V1beta1ValidatingAdmissionPolicyBindingList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta1/validating_admission_policy_binding.v1beta1.ValidatingAdmissionPolicyBinding(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/validating_admission_policy_binding_spec.v1beta1.ValidatingAdmissionPolicyBindingSpec(
                            match_resources = kubernetes_asyncio.client.models.v1beta1/match_resources.v1beta1.MatchResources(
                            ...
                            param_ref = kubernetes_asyncio.client.models.v1beta1/param_ref.v1beta1.ParamRef(
                                name = '', 
                                namespace = '', 
