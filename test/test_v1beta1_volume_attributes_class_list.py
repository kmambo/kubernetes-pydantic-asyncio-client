...
class TestV1beta1VolumeAttributesClassList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1VolumeAttributesClassList:
        """Test V1beta1VolumeAttributesClassList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta1VolumeAttributesClassList`
        """
        model = V1beta1VolumeAttributesClassList()
        if include_optional:
            return V1beta1VolumeAttributesClassList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta1/volume_attributes_class.v1beta1.VolumeAttributesClass(
                        api_version = '', 
                        driver_name = '', 
                        kind = '', 
    ...
    def testV1beta1VolumeAttributesClassList(self):
        """Test V1beta1VolumeAttributesClassList"""
