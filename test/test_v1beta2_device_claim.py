...
class TestV1beta2DeviceClaim(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta2DeviceClaim:
        """Test V1beta2DeviceClaim
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta2DeviceClaim`
        """
        model = V1beta2DeviceClaim()
        if include_optional:
    ...
    def testV1beta2DeviceClaim(self):
        """Test V1beta2DeviceClaim"""
