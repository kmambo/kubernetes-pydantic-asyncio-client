...
class TestV1beta2DeviceClassList(unittest.TestCase):
    """V1beta2DeviceClassList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta2DeviceClassList:
        """Test V1beta2DeviceClassList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta2DeviceClassList`
        """
        model = V1beta2DeviceClassList()
        if include_optional:
            return V1beta2DeviceClassList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta2/device_class.v1beta2.DeviceClass(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1beta2/device_class_spec.v1beta2.DeviceClassSpec(
                            config = [
    ...
    def testV1beta2DeviceClassList(self):
        """Test V1beta2DeviceClassList"""
