...
class TestV1beta2DeviceClassSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta2DeviceClassSpec:
        """Test V1beta2DeviceClassSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta2DeviceClassSpec`
        """
        model = V1beta2DeviceClassSpec()
        if include_optional:
