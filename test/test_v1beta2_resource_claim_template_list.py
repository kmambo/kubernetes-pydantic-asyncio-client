...
class TestV1beta2ResourceClaimTemplateList(unittest.TestCase):
    """V1beta2ResourceClaimTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta2ResourceClaimTemplateList:
        """Test V1beta2ResourceClaimTemplateList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1beta2ResourceClaimTemplateList`
        """
        model = V1beta2ResourceClaimTemplateList()
        if include_optional:
            return V1beta2ResourceClaimTemplateList(
                api_version = '',
                items = [
                    kubernetes_asyncio.client.models.v1beta2/resource_claim_template.v1beta2.ResourceClaimTemplate(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes_asyncio.client.models.v1beta2/resource_claim_template_spec.v1beta2.ResourceClaimTemplateSpec(
    ...
    def testV1beta2ResourceClaimTemplateList(self):
        """Test V1beta2ResourceClaimTemplateList"""
